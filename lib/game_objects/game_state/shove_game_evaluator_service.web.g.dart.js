...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    ShoveGameEvaluatorService__findBestMove(shoveGameDto) {
      var $async$goto = 0,
        ...
        $async$returnValue, bestMove, shoveGame, stopwatch;
    ...
    ShovePiece: function ShovePiece(t0, t1) {
      this.pieceType = t0;
    ...
    ShoveSquare_ShoveSquare$fromDto(dto) {
      var t1 = dto.piece;
      t1 = t1 != null ? new A.ShovePiece(t1.pieceType, A.IPlayer_IPlayer$fromDto(t1.owner)) : null;
  ...
  A.ShoveGame_ShoveGame$fromDto_closure.prototype = {
    call$1(e) {
      ...
      return new A.ShovePiece(e.pieceType, A.IPlayer_IPlayer$fromDto(e.owner));
    },
    $signature: 35
  };
