...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _$ShoveGameStateDtoFromJson(json) {
      var t6, t7, t8,
        ...
        t3 = J.map$2$1$ax(t2._as(t1.$index(json, "board")), new A._$ShoveGameStateDtoFromJson_closure(), type$.String, type$.ShoveSquareDto),
        t4 = type$.List_dynamic,
        t5 = J.map$1$1$ax(t4._as(t1.$index(json, "pieces")), new A._$ShoveGameStateDtoFromJson_closure0(), type$.ShovePieceDto);
      t5 = A.List_List$of(t5, true, t5.$ti._eval$1("ListIterable.E"));
      t4 = J.map$1$1$ax(t4._as(t1.$index(json, "allMadeMoves")), new A._$ShoveGameStateDtoFromJson_closure1(), type$.ShoveGameMoveDto);
      ...
      return new A.ShoveGameStateDto(t3, t5, t4, t6, t7, t8, t1 == null ? null : new A._$ShoveGameStateDtoFromJson_closure2().call$1(t2._as(t1)));
    },
    ...
    ShovePieceDto_ShovePieceDto$fromPiece(piece) {
      var t1 = piece.owner;
      return new A.ShovePieceDto(piece.pieceType, J.toString$0$(piece.texture), piece.isIncapacitated, new A.ShovePlayerDto(t1.playerName, t1.isWhite, A._rtiToString(A.getRuntimeTypeOfDartObject(t1)._rti, null)));
    },
    _$ShovePieceDtoFromJson(json) {
      var t1 = J.getInterceptor$ax(json);
      return new A.ShovePieceDto(A.$enumDecode(B.Map_xwIwp, t1.$index(json, "pieceType"), type$.PieceType, type$.String), A._asString(t1.$index(json, "texture")), A._asBool(t1.$index(json, "isIncapacitated")), A._$ShovePlayerDtoFromJson(type$.Map_String_dynamic._as(t1.$index(json, "owner"))));
    },
    ShovePieceDto: function ShovePieceDto(t0, t1, t2, t3) {
      var _ = this;
      _.pieceType = t0;
      _.texture = t1;
      _.isIncapacitated = t2;
      _.owner = t3;
    },
    ...
    ShoveSquareDto_ShoveSquareDto$fromSquare(square) {
      var t1 = square.piece;
      t1 = t1 != null ? A.ShovePieceDto_ShovePieceDto$fromPiece(t1) : null;
      return new A.ShoveSquareDto(square.x, square.y, t1);
    },
    _$ShoveSquareDtoFromJson(json) {
      var t1 = J.getInterceptor$ax(json),
        t2 = A._asInt(t1.$index(json, "x")),
        t3 = A._asInt(t1.$index(json, "y"));
      return new A.ShoveSquareDto(t2, t3, t1.$index(json, "piece") == null ? null : A._$ShovePieceDtoFromJson(type$.Map_String_dynamic._as(t1.$index(json, "piece"))));
    },
    ...
    ShoveGameEvaluatorService__findBestMove(shoveGameDto) {
      var $async$goto = 0,
        ...
        $async$returnValue, bestMove, t1, t2, t3, t4, t5, t6, t7, t8, shoveGame, stopwatch;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              t2 = A.ShoveSquareDto_ShoveSquareDto$fromSquare(t1.oldSquare);
              t3 = A.ShoveSquareDto_ShoveSquareDto$fromSquare(t1.newSquare);
              t4 = t1.shoveGameMoveType;
              t5 = t1.madeBy;
              t6 = A._rtiToString(A.getRuntimeTypeOfDartObject(t5)._rti, null);
              t7 = t1.throwerSquare;
              t7 = t7 != null ? A.ShoveSquareDto_ShoveSquareDto$fromSquare(t7) : null;
              t8 = t1.shovedPiece;
              if (t8 != null)
                A.ShovePieceDto_ShovePieceDto$fromPiece(t8);
              t8 = t1.shovedToSquare;
              if (t8 != null)
                A.ShoveSquareDto_ShoveSquareDto$fromSquare(t8);
              t8 = t1.leapedOverSquare;
              if (t8 != null)
                A.ShoveSquareDto_ShoveSquareDto$fromSquare(t8);
              t1 = t1.thrownPiece;
              if (t1 != null)
                A.ShovePieceDto_ShovePieceDto$fromPiece(t1);
              $async$returnValue = B.C_JsonCodec.encode$2$toEncodable(A._$ShoveGameMoveDtoToJson(new A.ShoveGameMoveDto(t2, t3, t4, new A.ShovePlayerDto(t5.playerName, t5.isWhite, t6), t7)), null);
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    ShoveGame_ShoveGame$fromDto(dto) {
      var board, t4, t5, allMadeMoves, currentPlayersTurn, gameOverState,
        player1 = A.IPlayer_IPlayer$fromDto(dto.player1),
        player2 = A.IPlayer_IPlayer$fromDto(dto.player2),
        t1 = dto.pieces,
        t2 = A._arrayInstanceType(t1),
        t3 = t2._eval$1("MappedListIterable<1,ShovePiece>"),
        pieces = A.List_List$of(new A.MappedListIterable(t1, t2._eval$1("ShovePiece(1)")._as(new A.ShoveGame_ShoveGame$fromDto_closure()), t3), true, t3._eval$1("ListIterable.E"));
      t3 = dto.board;
      t2 = type$.Record_2_int_and_int;
      t1 = type$.ShoveSquare;
      board = t3.map$2$1(t3, new A.ShoveGame_ShoveGame$fromDto_closure0(), t2, t1);
      t3 = dto.allMadeMoves;
      t4 = A._arrayInstanceType(t3);
      t5 = t4._eval$1("MappedListIterable<1,ShoveGameMove>");
      allMadeMoves = A.List_List$of(new A.MappedListIterable(t3, t4._eval$1("ShoveGameMove(1)")._as(new A.ShoveGame_ShoveGame$fromDto_closure1()), t5), true, t5._eval$1("ListIterable.E"));
      currentPlayersTurn = A.IPlayer_IPlayer$fromDto(dto.currentPlayersTurn);
      t3 = dto.gameOverState;
      if (t3 != null) {
        t4 = t3._1;
        t4.toString;
        t4 = A.IPlayer_IPlayer$fromDto(t4);
        gameOverState = new A._Record_2_isOver_winner(t3._0, t4);
      } else
        gameOverState = null;
      t1 = A.ShoveGame$(player1, player2, currentPlayersTurn, A.HashMap_HashMap$from(board, t2, t1), pieces);
    ...
    ShovePiece: function ShovePiece(t0, t1, t2) {
      var _ = this;
      _.pieceType = t0;
      _.texture = t1;
    ...
    ShoveSquare_ShoveSquare$fromDto(dto) {
      var t1 = dto.piece;
      t1 = t1 != null ? new A.ShovePiece(t1.pieceType, null, A.IPlayer_IPlayer$fromDto(t1.owner)) : null;
      return new A.ShoveSquare(dto.x, dto.y, t1);
    },
  ...
  A._$ShoveGameStateDtoFromJson_closure0.prototype = {
    call$1(e) {
      return A._$ShovePieceDtoFromJson(type$.Map_String_dynamic._as(e));
    },
    $signature: 22
  };
  ...
  A.ShovePieceDto.prototype = {
    toJson$0() {
      ...
      t1.toString;
      return A.LinkedHashMap_LinkedHashMap$_literal(["pieceType", t1, "texture", _this.texture, "isIncapacitated", _this.isIncapacitated, "owner", _this.owner], type$.String, type$.dynamic);
    }
  };
  ...
  A.ShoveSquareDto.prototype = {
    toJson$0() {
      return A.LinkedHashMap_LinkedHashMap$_literal(["x", this.x, "y", this.y, "piece", this.piece], type$.String, type$.dynamic);
    }
  };
  A.ShoveGameEvaluator.prototype = {
    ...
    minmax$body$ShoveGameEvaluator(game, maximizingPlayer, depth, alpha, beta, stateCalculationCache, stopwatch) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, t1, bestScore, t2, t3, bestMove, _i, move, score;
    ...
    evaluateGameState$2(game, maximizingPlayer) {
      var t1, score, t2, t3, t4, t5, isMaximizingPlayersPiece, isOpponentsPiece, t6, t7, t8, pieceDistancetoOpponentGoal, countThrowableNeighbors, countBlockableNeighbors, countShoveableNeighbors, _null = null;
      if (game.get$isGameOver()) {
        ...
        score = 0;
      for (t1 = game.board, t1 = t1.get$values(t1), t2 = A._instanceType(t1), t2 = t2._eval$1("@<1>")._bind$1(t2._rest[1]), t1 = new A.MappedIterator(J.get$iterator$ax(t1.__internal$_iterable), t1._f, t2._eval$1("MappedIterator<1,2>")), t2 = t2._rest[1]; t1.moveNext$0();) {
        t3 = t1.__internal$_current;
        if (t3 == null)
          t3 = t2._as(t3);
        t4 = t3.piece;
        t5 = t4 == null;
        isMaximizingPlayersPiece = J.$eq$(t5 ? _null : t4.owner, maximizingPlayer) && t3.piece != null;
        t4 = t3.piece;
        isOpponentsPiece = !J.$eq$(t4 == null ? _null : t4.owner, maximizingPlayer) && t3.piece != null;
        t4 = t3.piece;
        t6 = t4 == null;
        t7 = t6 ? _null : t4.pieceType;
        t8 = t6 ? _null : t4.pieceType;
        t6 = t6 ? _null : t4.pieceType;
        if (!t5 && t6 !== B.PieceType_3_leaper) {
          pieceDistancetoOpponentGoal = game.getSquaresDistanceToGoal$2(t4.owner, t3) / 10;
          score -= isMaximizingPlayersPiece ? pieceDistancetoOpponentGoal : -pieceDistancetoOpponentGoal;
        }
        if (isMaximizingPlayersPiece) {
          t4 = t3.piece;
          t4 = t4 == null ? _null : t4.pieceType.pieceValue;
          score += t4 == null ? 0 : t4;
        ...
        t4 = t3.piece;
        if ((t4 == null ? _null : t4.isIncapacitated) === true)
          score += isMaximizingPlayersPiece ? -0.5 : 0.5;
        if (t7 === B.PieceType_5_thrower) {
          t4 = game.getAllNeighborSquares$1(t3);
          t5 = A._arrayInstanceType(t4);
          t5 = new A.WhereIterable(t4, t5._eval$1("bool(1)")._as(new A.ShoveGameEvaluator_evaluateGameState_closure(game)), t5._eval$1("WhereIterable<1>"));
          countThrowableNeighbors = t5.get$length(t5);
          score += isMaximizingPlayersPiece ? countThrowableNeighbors * 2 : -countThrowableNeighbors * 2;
        }
        t4 = t3.piece;
        if ((t4 == null ? _null : t4.pieceType) === B.PieceType_1_blocker) {
          t4 = game.getAllNeighborSquares$1(t3);
          t5 = A._arrayInstanceType(t4);
          t5 = new A.WhereIterable(t4, t5._eval$1("bool(1)")._as(new A.ShoveGameEvaluator_evaluateGameState_closure0(game)), t5._eval$1("WhereIterable<1>"));
          countBlockableNeighbors = t5.get$length(t5);
          score += isMaximizingPlayersPiece ? countBlockableNeighbors : -countBlockableNeighbors;
        }
        if (t8 === B.PieceType_2_shover) {
          t3 = game.getAllNeighborSquares$1(t3);
          t4 = A._arrayInstanceType(t3);
          t4 = new A.WhereIterable(t3, t4._eval$1("bool(1)")._as(new A.ShoveGameEvaluator_evaluateGameState_closure1(game)), t4._eval$1("WhereIterable<1>"));
          countShoveableNeighbors = t4.get$length(t4);
  ...
  A.ShoveGameEvaluator_evaluateGameState_closure.prototype = {
    call$1(element) {
      ...
      if (t1 != null) {
        ...
        t2 = this.game;
        t3 = t2.player1;
        if (J.$eq$(t1, t1.$eq(0, t3) ? t2.player2 : t3)) {
          t1 = element.piece;
          t1 = (t1 == null ? null : t1.pieceType) !== B.PieceType_1_blocker;
        } else
          t1 = false;
      } else
        t1 = false;
  ...
  A.ShoveGame.prototype = {
    ...
    validateThrow$3(thrower, thrownFromSquare, thrownToSquare) {
      var throwerIsThrowerAndNotIncapacitated, throwerBelongsToCurrentPlayer, t3, thrownPieceIsNextToFriendlyBlocker, t4, _this = this, _null = null,
        t1 = thrower.piece,
        t2 = t1 == null;
      if ((t2 ? _null : t1.pieceType) === B.PieceType_5_thrower)
        throwerIsThrowerAndNotIncapacitated = (t2 ? _null : t1.isIncapacitated) === false;
      else
        throwerIsThrowerAndNotIncapacitated = false;
      t1 = t2 ? _null : t1.owner;
      throwerBelongsToCurrentPlayer = J.$eq$(t1, _this.currentPlayersTurn);
      t1 = thrownFromSquare.piece;
      t1 = t1 == null ? _null : t1.owner;
      t1 = J.$eq$(t1, _this.currentPlayersTurn);
      t2 = thrownFromSquare.piece;
      t2 = t2 == null ? _null : t2.isIncapacitated;
      t3 = thrownToSquare.piece;
      ...
      if (Math.abs(thrower.y - thrownToSquare.y) > 1)
        return false;
      t1 = _this.board.$index(0, new A._Record_2(thrownFromSquare.x, thrownFromSquare.y));
      if (t1 == null)
        t1 = _null;
      else {
        t1 = t1.piece;
        t1 = t1 == null ? _null : t1.pieceType;
      }
      if (t1 === B.PieceType_1_blocker)
        return false;
      if (t3 != null)
        return false;
      return true;
    ...
    validateMove$1(shoveGameMove) {
      var t5, t6, t7, t8, direction, _this = this, _null = null,
        t1 = shoveGameMove.oldSquare,
        t2 = t1.x,
      ...
      if (t5 == null)
        return false;
      t6 = t5.isIncapacitated;
      if (t6 === true)
        return false;
      if (shoveGameMove.shoveGameMoveType === B.ShoveGameMoveType_1) {
        t2 = shoveGameMove.throwerSquare;
        t2.toString;
        return _this.validateThrow$3(t2, t1, t3);
      }
      t5 = t5.owner;
      ...
      switch (t6.pieceType) {
        case B.PieceType_2_shover:
          ...
          if (t6.isWhite === true) {
            ...
            return false;
          t2 = _this.board;
          t6 = t2.$index(0, new A._Record_2(t4, t5)).piece;
          if ((t6 == null ? _null : t6.pieceType) === B.PieceType_1_blocker)
            return false;
          if (t7 && t8 > 0)
            return false;
          direction = _this.calculateShoveDirection$2(t1, t3);
          if (direction == null)
            return false;
          t3 = t2.$index(0, new A._Record_2(t4, t5));
          if ((t3 == null ? _null : t3.piece) != null)
            if (_this.shoveResultsInCollision$3(direction, t4, t5))
              return false;
          break;
        case B.PieceType_1_blocker:
          t3 = Math.abs(t2 - t4);
          if (t3 > 0 && Math.abs(t1.y - t5) > 0)
            return false;
          if (t3 > 2 || Math.abs(t1.y - t5) > 2)
            return false;
          if (t3 > 1 || Math.abs(t1.y - t5) > 1)
            if (_this.board.$index(0, new A._Record_2(B.JSInt_methods._tdivFast$1(t2 + t4, 2), B.JSInt_methods._tdivFast$1(t1.y + t5, 2))).piece != null)
              return false;
          t2 = _this.board;
          t3 = t2.$index(0, new A._Record_2(t4, t5));
          if ((t3 == null ? _null : t3.piece) != null)
        ...
        case B.PieceType_3_leaper:
          ...
          if ((t7 == null ? _null : t7.piece) != null)
            return false;
          t7 = t1.y;
          if (t6.$index(0, new A._Record_2(B.JSInt_methods._tdivFast$1(t2 + t4, 2), B.JSInt_methods._tdivFast$1(t7 + t5, 2))).piece == null) {
            if (t3 > 1 || Math.abs(t7 - t5) > 1)
              return false;
          } else if (t3 > 2 || Math.abs(t7 - t5) > 2)
            return false;
          t2 = t6;
          break;
        case B.PieceType_5_thrower:
          if (Math.abs(t2 - t4) > 1 || Math.abs(t1.y - t5) > 1)
            return false;
          t2 = _this.board;
          t3 = t2.$index(0, new A._Record_2(t4, t5));
          if ((t3 == null ? _null : t3.piece) != null)
      ...
      t2 = t2.$index(0, new A._Record_2(t4, t5));
      if (t2 == null)
        t2 = _null;
      else {
        t2 = t2.piece;
        t2 = t2 == null ? _null : t2.owner;
      }
      t1 = t1.piece;
      if (J.$eq$(t2, t1 == null ? _null : t1.owner))
        return false;
      return true;
    },
    isOutOfBounds$2(x, y) {
    ...
    move$1(shoveGameMove) {
      var t1, shoveDirection, audioToPlay, t2, t3, _this = this, _null = null,
        opponentSquare = shoveGameMove.newSquare;
      if (opponentSquare.piece != null) {
        t1 = shoveGameMove.oldSquare.piece;
        t1 = (t1 == null ? _null : t1.pieceType) === B.PieceType_2_shover;
      } else
        t1 = false;
      if (t1) {
        t1 = shoveGameMove.oldSquare;
        shoveDirection = _this.calculateShoveDirection$2(t1, opponentSquare);
        if (shoveDirection == null) {
          t1 = t1.piece;
          throw A.wrapException(A.Exception_Exception(A.S(t1 == null ? _null : t1.owner.playerName) + " made an invalid move!"));
        }
      ...
      t1 = shoveGameMove.oldSquare;
      t2 = t1.piece;
      if ((t2 == null ? _null : t2.pieceType) === B.PieceType_3_leaper) {
        t2 = _this.board.$index(0, new A._Record_2(B.JSInt_methods._tdivFast$1(t1.x + opponentSquare.x, 2), B.JSInt_methods._tdivFast$1(t1.y + opponentSquare.y, 2)));
        t3 = t2.piece;
        if (t3 != null)
          t3.isIncapacitated = true;
        shoveGameMove.leapedOverSquare = t2;
      }
      if (shoveGameMove.shoveGameMoveType === B.ShoveGameMoveType_1)
        audioToPlay = shoveGameMove.throwPiece$1(_this);
      else {
        t2 = _this.board;
        t2.$index(0, new A._Record_2(opponentSquare.x, opponentSquare.y)).piece = t1.piece;
        t2.$index(0, new A._Record_2(t1.x, t1.y)).piece = null;
        if (audioToPlay == null)
    ...
    shoveResultsInCollision$3(direction, x, y) {
      ...
      switch (direction) {
        case B.ShoveDirection_0:
          ...
          t1 = (t1 == null ? _null : t1.piece) != null;
          break;
        case B.ShoveDirection_1:
          t1 = _this.board.$index(0, new A._Record_2(x - 1, y));
          t1 = (t1 == null ? _null : t1.piece) != null;
    ...
    undoLastMove$0() {
      var lastMove, t3, t4, t5, t6, _this = this,
      ...
      t3 = t4.x;
      t5 = t4.y;
      t2.$index(0, new A._Record_2(t3, t5)).piece = null;
      ...
      if (t6 != null) {
        ...
        if (t6 != null)
          t6.piece = null;
        t2.$index(0, new A._Record_2(t3, t5)).piece = lastMove.shovedPiece;
      }
  ...
  A.ShoveGame_ShoveGame$fromDto_closure.prototype = {
    call$1(e) {
      type$.ShovePieceDto._as(e);
      return new A.ShovePiece(e.pieceType, null, A.IPlayer_IPlayer$fromDto(e.owner));
    },
    $signature: 35
  };
  A.ShoveGame_ShoveGame$fromDto_closure0.prototype = {
    call$2(key, value) {
      ...
      if (1 >= t2.length)
        return A.ioore(t2, 1);
      return new A.MapEntry(new A._Record_2(t1, A.int_parse(t2[1])), A.ShoveSquare_ShoveSquare$fromDto(value), type$.MapEntry_of_Record_2_int_and_int_and_ShoveSquare);
    },
    $signature: 29
  };
  A.ShoveGame_ShoveGame$fromDto_closure1.prototype = {
    call$1(e) {
      ...
      t1 = A.ShoveSquare_ShoveSquare$fromDto(e.oldSquare);
      t2 = A.ShoveSquare_ShoveSquare$fromDto(e.newSquare);
      t3 = A.IPlayer_IPlayer$fromDto(e.madeBy);
      t4 = e.throwerSquare;
      t4 = t4 != null ? A.ShoveSquare_ShoveSquare$fromDto(t4) : null;
      return new A.ShoveGameMove(t1, t2, t4 != null ? B.ShoveGameMoveType_1 : B.ShoveGameMoveType_0, t3, t4);
    },
    $signature: 30
  };
  A.ShoveGame_validateThrow_closure.prototype = {
    call$1(element) {
      var t1 = type$.ShoveSquare._as(element).piece,
        t2 = t1 == null;
      if ((t2 ? null : t1.pieceType) === B.PieceType_1_blocker) {
        t1 = t2 ? null : t1.owner;
        t1 = !J.$eq$(t1, this.$this.currentPlayersTurn);
      } else
        t1 = false;
      return t1;
    },
  ...
  A.ShoveGame_checkIfGameIsOver_closure.prototype = {
    call$1(element) {
      ...
      type$.ShoveSquare._as(element);
      t1 = element.piece;
      t1 = t1 == null ? null : t1.owner;
      if (J.$eq$(t1, this.$this.player1)) {
        t1 = element.piece;
        t1 = (t1 == null ? null : t1.pieceType) === B.PieceType_2_shover;
      } else
        t1 = false;
      return t1;
    },
  ...
  A.ShoveGameMove.prototype = {
    _revertPieceOutOfBounds$2(shoveGame, piece) {
      ...
      if (!B.JSArray_methods.contains$1(t1, piece))
        B.JSArray_methods.add$1(t1, piece);
    },
    shove$4(x, y, shovedSquare, shoveGame) {
      var audioToPlay,
        t1 = shoveGame.isOutOfBounds$2(x, y),
        t2 = shovedSquare.piece;
      if (t1) {
        t2.toString;
        B.JSArray_methods.remove$1(shoveGame.pieces, t2);
        audioToPlay = B.AudioAssets_scream;
      } else {
        if (t2 != null)
          t2.isIncapacitated = true;
        t1 = shoveGame.board.$index(0, new A._Record_2(x, y));
        if (t1 != null)
          t1.piece = shovedSquare.piece;
        this.shovedToSquare = t1;
        audioToPlay = B.AudioAssets_bonk;
      }
      this.shovedPiece = shovedSquare.piece;
    ...
    throwPiece$1(shoveGame) {
      var t2, t3, t4, t5, t6, t7, t8,
        t1 = this.oldSquare;
      this.thrownPiece = t1.piece;
      t2 = this.newSquare;
      t3 = t2.x;
      t2 = t2.y;
      t4 = shoveGame.isOutOfBounds$2(t3, t2);
      t5 = t1.piece;
      t6 = shoveGame.board;
      t7 = t1.x;
      t8 = t1.y;
      if (t4) {
        t5.toString;
        B.JSArray_methods.remove$1(shoveGame.pieces, t5);
        t6.$index(0, new A._Record_2(t7, t8)).piece = null;
        return B.AudioAssets_scream;
      } else {
        t5.isIncapacitated = true;
        t6.$index(0, new A._Record_2(t3, t2)).piece = t1.piece;
        t6.$index(0, new A._Record_2(t7, t8)).piece = null;
    ...
    revertIncapacition$1(shoveGame) {
      var t1, t2, t3;
      for (t1 = shoveGame.pieces, t2 = A._arrayInstanceType(t1), t3 = t2._eval$1("bool(1)")._as(new A.ShoveGameMove_revertIncapacition_closure(shoveGame)), t1 = B.JSArray_methods.get$iterator(t1), t2 = new A.WhereIterator(t1, t3, t2._eval$1("WhereIterator<1>")); t2.moveNext$0();)
  ...
  A.ShoveSquare.prototype = {
    toString$0(_) {
      return "ShoveSquare{x: " + this.x + ", y: " + this.y + ", piece: " + A.S(this.piece) + "}";
    },
    $eq(_, other) {
      var t1, _this = this;
      if (other == null)
        return false;
      if (_this !== other)
        t1 = other instanceof A.ShoveSquare && A.getRuntimeTypeOfDartObject(_this) === A.getRuntimeTypeOfDartObject(other) && _this.x === other.x && _this.y === other.y && J.$eq$(_this.piece, other.piece);
      else
        t1 = true;
      return t1;
    },
    get$hashCode(_) {
      return (B.JSInt_methods.get$hashCode(this.x) ^ B.JSInt_methods.get$hashCode(this.y) ^ J.get$hashCode$(this.piece)) >>> 0;
    }
  };
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(String,@)", "bool(ShoveSquare)", "~(@)", "~(@,@)", "Null()", "~(~())", "bool(@)", "Null(@)", "int()", "@(@)", "@(String)", "~(MessageEvent)", "~(String,String)", "~(Object?,Object?)", "Future<Null>()", "@(@,String)", "_Future<@>(@)", "~(Event)", "Null(@,@)", "@(@,@)", "Null(Object,StackTrace)", "ShovePieceDto(@)", "ShoveGameMoveDto(@)", "+isOver,winner(bool,ShovePlayerDto?)(Map<@,@>)", "~(int,@)", "Future<double>(List<@>)", "Future<String?>(List<@>)", "Null(@,StackTrace)", "MapEntry<+(int,int),ShoveSquare>(String,ShoveSquareDto)", "ShoveGameMove(ShoveGameMoveDto)", "bool(List<0^>,List<0^>)<Object?>", "bool(IPlayer)", "bool(ShoveGameMove)", "bool(ShovePiece)", "ShovePiece(ShovePieceDto)", "String()", "CancellationTokenReference()", "bool(int)", "~(Object,StackTrace)", "Null(~())", "WorkerService(List<@>)", "MapEntry<String,ShoveSquareDto>(String,@)"],
