...
(function dartProgram() {
  ...
  A.RandomAi.prototype = {
    $eq(_, other) {
      ...
      if (other == null)
        return false;
      if (other instanceof A.RandomAi)
  ...
  A.ShovePlayerDto.prototype = {
    ...
    $eq(_, other) {
      ...
      if (other == null)
        return false;
      if (other instanceof A.ShovePlayer)
        return _this.playerName === other.playerName && _this.isWhite === other.isWhite;
  ...
  A.ShoveGameEvaluatorService.prototype = {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = type$.Map_String_dynamic;
              $async$returnValue = B.C_ShoveGameEvaluator.evaluateGameState$2(A.ShoveGame_ShoveGame$fromDto(A._$ShoveGameStateDtoFromJson(t1._as(B.C_JsonCodec.decode$2$reviver(0, shoveGameJson, null)))), A._$ShovePlayerDtoFromJson(t1._as(B.C_JsonCodec.decode$2$reviver(0, shovePlayerJson, null))));
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    findBestMove$1(shoveGameJson) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Record_2_double_and_nullable_ShoveGameMove),
        $async$returnValue, t1, bestMove, shoveGame, stopwatch;
      var $async$findBestMove$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              shoveGame = A.ShoveGame_ShoveGame$fromDto(A._$ShoveGameStateDtoFromJson(type$.Map_String_dynamic._as(B.C_JsonCodec.decode$2$reviver(0, shoveGameJson, null))));
              stopwatch = new A.Stopwatch();
              $.$get$Stopwatch__frequency();
              t1 = $.Primitives_timerTicks.call$0();
              stopwatch._start = t1 - 0;
              stopwatch._stop = null;
              bestMove = B.C_ShoveGameEvaluator.minmax$5$stateCalculationCache$stopwatch(shoveGame, shoveGame.currentPlayersTurn, 20, A.HashMap_HashMap(type$.int, type$.Record_2_double_and_nullable_ShoveGameMove), stopwatch);
  ...
  A.ShovePiece.prototype = {
    ...
    get$hashCode(_) {
      var t1 = this.owner;
      return (A.Primitives_objectHashCode(this.pieceType) ^ t1.get$hashCode(t1)) >>> 0;
    }
  };
  A.ShovePlayer.prototype = {
    ...
    $eq(_, other) {
      if (other == null)
        return false;
      if (other instanceof A.ShovePlayer)
        return this.playerName === other.playerName && this.isWhite === other.isWhite;
      return false;
    }
  };
