...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _Record_2_isOver_winner: function _Record_2_isOver_winner(t0, t1) {
      this._0 = t0;
      this._1 = t1;
    },
    ...
    MinMaxAi: function MinMaxAi(t0, t1, t2) {
      this.stopwatch = t0;
      this.playerName = t1;
      this.isWhite = t2;
    },
    RandomAi: function RandomAi(t0, t1) {
      this.playerName = t0;
      this.isWhite = t1;
    },
    IPlayer_IPlayer$fromDto(dto) {
      switch (dto.type) {
        case "ShovePlayer":
          return new A.ShovePlayer(dto.playerName, dto.isWhite);
        case "MinMaxAi":
          $.$get$Stopwatch__frequency();
          return new A.MinMaxAi(new A.Stopwatch(), dto.playerName, dto.isWhite);
        case "RandomAi":
          return new A.RandomAi(dto.playerName, dto.isWhite);
      }
      return new A.ShovePlayer(dto.playerName, dto.isWhite);
    },
    IPlayer: function IPlayer() {
    },
    _$ShoveGameMoveDtoToJson(instance) {
      var t1 = B.Map_oy1Wi.$index(0, instance.shoveGameMoveType);
      t1.toString;
      return A.LinkedHashMap_LinkedHashMap$_literal(["oldSquare", instance.oldSquare, "newSquare", instance.newSquare, "shoveGameMoveType", t1, "madeBy", instance.madeBy, "throwerSquare", instance.throwerSquare], type$.String, type$.dynamic);
    },
    ShoveGameMoveDto: function ShoveGameMoveDto(t0, t1, t2, t3, t4) {
      var _ = this;
      _.oldSquare = t0;
      _.newSquare = t1;
      _.shoveGameMoveType = t2;
      _.madeBy = t3;
      _.throwerSquare = t4;
    },
    _$ShoveGameStateDtoFromJson(json) {
      var t5, t6, t7, t8,
        t1 = J.getInterceptor$ax(json),
        t2 = type$.Map_String_dynamic,
        t3 = type$.String,
        t4 = J.map$2$1$ax(t2._as(t1.$index(json, "board")), new A._$ShoveGameStateDtoFromJson_closure(), t3, type$.ShoveSquareDto);
      t3 = J.map$2$1$ax(t2._as(t1.$index(json, "pieces")), new A._$ShoveGameStateDtoFromJson_closure0(), t3, type$.ShovePieceDto);
      t5 = J.map$1$1$ax(type$.List_dynamic._as(t1.$index(json, "allMadeMoves")), new A._$ShoveGameStateDtoFromJson_closure1(), type$.ShoveGameMoveDto);
      t5 = A.List_List$of(t5, true, t5.$ti._eval$1("ListIterable.E"));
      t6 = A._$ShovePlayerDtoFromJson(t2._as(t1.$index(json, "player1")));
      t7 = A._$ShovePlayerDtoFromJson(t2._as(t1.$index(json, "player2")));
      t8 = A._$ShovePlayerDtoFromJson(t2._as(t1.$index(json, "currentPlayersTurn")));
      t1 = t1.$index(json, "gameOverState");
      return new A.ShoveGameStateDto(t4, t3, t5, t6, t7, t8, t1 == null ? null : new A._$ShoveGameStateDtoFromJson_closure2().call$1(t2._as(t1)));
    },
    ShoveGameStateDto: function ShoveGameStateDto(t0, t1, t2, t3, t4, t5, t6) {
      var _ = this;
      _.board = t0;
      _.pieces = t1;
      _.allMadeMoves = t2;
      _.player1 = t3;
      _.player2 = t4;
      _.currentPlayersTurn = t5;
      _.gameOverState = t6;
    },
    _$ShoveGameStateDtoFromJson_closure: function _$ShoveGameStateDtoFromJson_closure() {
    },
    _$ShoveGameStateDtoFromJson_closure0: function _$ShoveGameStateDtoFromJson_closure0() {
    },
    _$ShoveGameStateDtoFromJson_closure1: function _$ShoveGameStateDtoFromJson_closure1() {
    },
    _$ShoveGameStateDtoFromJson_closure2: function _$ShoveGameStateDtoFromJson_closure2() {
    },
    ShovePieceDto_ShovePieceDto$fromPiece(piece) {
      var t1 = piece.owner;
      return new A.ShovePieceDto(piece.id, piece.pieceType, J.toString$0$(piece.texture), piece.isIncapacitated, new A.ShovePlayerDto(t1.playerName, t1.isWhite, A._rtiToString(A.getRuntimeTypeOfDartObject(t1)._rti, null)));
    },
    ShovePieceDto: function ShovePieceDto(t0, t1, t2, t3, t4) {
      var _ = this;
      _.id = t0;
      _.pieceType = t1;
      _.texture = t2;
      _.isIncapacitated = t3;
      _.owner = t4;
    },
    _$ShovePlayerDtoFromJson(json) {
      var t1 = J.getInterceptor$ax(json);
      return new A.ShovePlayerDto(A._asString(t1.$index(json, "playerName")), A._asBool(t1.$index(json, "isWhite")), A._asString(t1.$index(json, "type")));
    },
    ShovePlayerDto: function ShovePlayerDto(t0, t1, t2) {
      this.playerName = t0;
      this.isWhite = t1;
      this.type = t2;
    },
    _$ShoveSquareDtoFromJson(json) {
      var t1 = J.getInterceptor$ax(json);
      return new A.ShoveSquareDto(A._asInt(t1.$index(json, "x")), A._asInt(t1.$index(json, "y")), A._asStringQ(t1.$index(json, "pieceId")));
    },
    ShoveSquareDto: function ShoveSquareDto(t0, t1, t2) {
      this.x = t0;
      this.y = t1;
      this.pieceId = t2;
    },
    ShoveGameEvaluator: function ShoveGameEvaluator() {
    },
    ShoveGameEvaluator_evaluateGameState_closure: function ShoveGameEvaluator_evaluateGameState_closure(t0) {
      this.game = t0;
    },
    ShoveGameEvaluator_evaluateGameState_closure0: function ShoveGameEvaluator_evaluateGameState_closure0(t0) {
      this.game = t0;
    },
    ShoveGameEvaluator_evaluateGameState_closure1: function ShoveGameEvaluator_evaluateGameState_closure1(t0) {
      this.game = t0;
    },
    ShoveGameEvaluatorService__findBestMove(shoveGameDto) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.nullable_String),
        $async$returnValue, bestMove, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, shoveGame, stopwatch;
      var $async$ShoveGameEvaluatorService__findBestMove = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              shoveGame = A.ShoveGame_ShoveGame$fromDto(A._$ShoveGameStateDtoFromJson(type$.Map_String_dynamic._as(B.C_JsonCodec.decode$2$reviver(0, shoveGameDto, null))));
              stopwatch = new A.Stopwatch();
              $.$get$Stopwatch__frequency();
              stopwatch.start$0(0);
              $async$goto = 3;
              return A._asyncAwait(B.C_ShoveGameEvaluator.minmax$5$stateCalculationCache$stopwatch(shoveGame, shoveGame.currentPlayersTurn, 20, A.HashMap_HashMap(type$.int, type$.Record_2_double_and_nullable_ShoveGameMove), stopwatch), $async$ShoveGameEvaluatorService__findBestMove);
            case 3:
              // returning from await.
              bestMove = $async$result;
              ...
              t4 = t1.newSquare;
              t5 = t4.pieceId;
              t6 = t1.shoveGameMoveType;
              t7 = t1.madeBy;
              t8 = A._rtiToString(A.getRuntimeTypeOfDartObject(t7)._rti, null);
              t9 = t1.throwerSquare;
              t9 = t9 != null ? new A.ShoveSquareDto(t9.x, t9.y, t9.pieceId) : null;
              t10 = t1.shovedPiece;
              if (t10 != null)
                A.ShovePieceDto_ShovePieceDto$fromPiece(t10);
              t1 = t1.thrownPiece;
              if (t1 != null)
                A.ShovePieceDto_ShovePieceDto$fromPiece(t1);
              $async$returnValue = B.C_JsonCodec.encode$2$toEncodable(A._$ShoveGameMoveDtoToJson(new A.ShoveGameMoveDto(new A.ShoveSquareDto(t2.x, t2.y, t3), new A.ShoveSquareDto(t4.x, t4.y, t5), t6, new A.ShovePlayerDto(t7.playerName, t7.isWhite, t8), t9)), null);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$ShoveGameEvaluatorService__findBestMove, $async$completer);
    },
    ShoveGameEvaluatorService__evaluateGameState(shoveGameDto, shovePlayerDto) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.double),
        $async$returnValue, currentEval, t1, shoveGame, shovePlayer, stopwatch;
      var $async$ShoveGameEvaluatorService__evaluateGameState = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              shoveGame = A.ShoveGame_ShoveGame$fromDto(A._$ShoveGameStateDtoFromJson(t1._as(B.C_JsonCodec.decode$2$reviver(0, shoveGameDto, null))));
              shovePlayer = A._$ShovePlayerDtoFromJson(t1._as(B.C_JsonCodec.decode$2$reviver(0, shovePlayerDto, null)));
              stopwatch = new A.Stopwatch();
              $.$get$Stopwatch__frequency();
              stopwatch.start$0(0);
              $async$goto = 3;
              return A._asyncAwait(B.C_ShoveGameEvaluator.minmax$5$stateCalculationCache$stopwatch(shoveGame, shovePlayer, 20, A.HashMap_HashMap(type$.int, type$.Record_2_double_and_nullable_ShoveGameMove), stopwatch), $async$ShoveGameEvaluatorService__evaluateGameState);
            case 3:
              // returning from await.
              currentEval = $async$result;
              if (stopwatch._stop == null)
                stopwatch._stop = $.Primitives_timerTicks.call$0();
              $async$returnValue = currentEval._0;
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$ShoveGameEvaluatorService__evaluateGameState, $async$completer);
    },
    $ShoveGameEvaluatorServiceInitializer(startRequest) {
      return new A._$ShoveGameEvaluatorServiceWorkerService();
    },
    ShoveGameEvaluatorService: function ShoveGameEvaluatorService() {
    },
    _$ShoveGameEvaluatorServiceWorkerService: function _$ShoveGameEvaluatorServiceWorkerService() {
      this.___$ShoveGameEvaluatorServiceWorkerService__operations_FI = $;
    },
    _$ShoveGameEvaluatorServiceWorkerService__operations_closure: function _$ShoveGameEvaluatorServiceWorkerService__operations_closure(t0) {
      this.$this = t0;
    },
    _$ShoveGameEvaluatorServiceWorkerService__operations_closure0: function _$ShoveGameEvaluatorServiceWorkerService__operations_closure0(t0) {
      this.$this = t0;
    },
    PieceType: function PieceType(t0, t1) {
      this.pieceValue = t0;
      this._name = t1;
    },
    ShoveDirection: function ShoveDirection(t0) {
      this._name = t0;
    },
    ShoveGame$(player1, player2, currentPlayersTurn, customBoard, customPieces) {
      var t1 = A._setArrayType([], type$.JSArray_ShoveGameMove),
        t2 = type$.JSArray_ShoveSquare,
        t3 = A._setArrayType([], t2);
      t2 = A._setArrayType([], t2);
      t1 = new A.ShoveGame(customPieces, t1, player1, player2, currentPlayersTurn, customBoard, t3, t2);
      t1.ShoveGame$5$currentPlayersTurn$customBoard$customPieces(player1, player2, currentPlayersTurn, customBoard, customPieces);
      return t1;
    },
    ShoveGame_ShoveGame$fromDto(dto) {
      var pieces, t4, t5, allMadeMoves, currentPlayersTurn, gameOverState,
        player1 = A.IPlayer_IPlayer$fromDto(dto.player1),
        player2 = A.IPlayer_IPlayer$fromDto(dto.player2),
        t1 = dto.board,
        t2 = type$.Record_2_int_and_int,
        t3 = type$.ShoveSquare,
        board = t1.map$2$1(t1, new A.ShoveGame_ShoveGame$fromDto_closure(), t2, t3);
      t1 = dto.pieces;
      pieces = t1.map$2$1(t1, new A.ShoveGame_ShoveGame$fromDto_closure0(), type$.String, type$.ShovePiece);
      t1 = dto.allMadeMoves;
      t4 = A._arrayInstanceType(t1);
      t5 = t4._eval$1("MappedListIterable<1,ShoveGameMove>");
      allMadeMoves = A.List_List$of(new A.MappedListIterable(t1, t4._eval$1("ShoveGameMove(1)")._as(new A.ShoveGame_ShoveGame$fromDto_closure1()), t5), true, t5._eval$1("ListIterable.E"));
      currentPlayersTurn = A.IPlayer_IPlayer$fromDto(dto.currentPlayersTurn);
      t1 = dto.gameOverState;
      if (t1 != null) {
        t4 = t1._1;
        t4.toString;
        t4 = A.IPlayer_IPlayer$fromDto(t4);
        gameOverState = new A._Record_2_isOver_winner(t1._0, t4);
      } else
        gameOverState = null;
      t1 = A.ShoveGame$(player1, player2, currentPlayersTurn, A.HashMap_HashMap$from(board, t2, t3), pieces);
      B.JSArray_methods.addAll$1(t1.allMadeMoves, allMadeMoves);
      t1.gameOverState = gameOverState;
      return t1;
    },
    ShoveGame: function ShoveGame(t0, t1, t2, t3, t4, t5, t6, t7) {
      var _ = this;
      _.pieces = t0;
      _.allMadeMoves = t1;
      _.player1 = t2;
      _.player2 = t3;
      _.currentPlayersTurn = t4;
      _.gameOverState = null;
      _.board = t5;
      _.player1GoalShoveSquares = t6;
      _.player2GoalShoveSquares = t7;
    },
    ShoveGame_ShoveGame$fromDto_closure: function ShoveGame_ShoveGame$fromDto_closure() {
    },
    ShoveGame_ShoveGame$fromDto_closure0: function ShoveGame_ShoveGame$fromDto_closure0() {
    },
    ShoveGame_ShoveGame$fromDto_closure1: function ShoveGame_ShoveGame$fromDto_closure1() {
    },
    ShoveGame_validateThrow_closure: function ShoveGame_validateThrow_closure(t0) {
      this.$this = t0;
    },
    ShoveGame_checkIfGameIsOver_listEquals: function ShoveGame_checkIfGameIsOver_listEquals() {
    },
    ShoveGame_checkIfGameIsOver_checkIfPlayerHasRepeatedSameMoveThreeTimes: function ShoveGame_checkIfGameIsOver_checkIfPlayerHasRepeatedSameMoveThreeTimes(t0, t1) {
      this.$this = t0;
      this.listEquals = t1;
    },
    ShoveGame_checkIfGameIsOver_checkIfPlayerHasRepeatedSameMoveThreeTimes_closure: function ShoveGame_checkIfGameIsOver_checkIfPlayerHasRepeatedSameMoveThreeTimes_closure(t0) {
      this.player = t0;
    },
    ShoveGame_checkIfGameIsOver_closure: function ShoveGame_checkIfGameIsOver_closure(t0) {
      this.$this = t0;
    },
    ShoveGame_checkIfGameIsOver_closure0: function ShoveGame_checkIfGameIsOver_closure0(t0) {
      this.$this = t0;
    },
    ShoveGameMove: function ShoveGameMove(t0, t1, t2, t3, t4) {
      var _ = this;
      _.oldSquare = t0;
      _.newSquare = t1;
      _.shoveGameMoveType = t2;
      _.madeBy = t3;
      _.throwerSquare = t4;
      _.thrownPiece = _.leapedOverSquare = _.shovedToSquare = _.shovedPiece = null;
    },
    ShoveGameMove_revertIncapacition_closure: function ShoveGameMove_revertIncapacition_closure(t0) {
      this.shoveGame = t0;
    },
    ShoveGameMoveType: function ShoveGameMoveType(t0) {
      this._name = t0;
    },
    ShovePiece: function ShovePiece(t0, t1, t2, t3) {
      var _ = this;
      _.id = t0;
      _.pieceType = t1;
      _.texture = t2;
      _.isIncapacitated = false;
      _.owner = t3;
    },
    ShovePlayer: function ShovePlayer(t0, t1) {
      this.playerName = t0;
      this.isWhite = t1;
    },
    ShoveSquare: function ShoveSquare(t0, t1, t2) {
      this.x = t0;
      this.y = t1;
      this.pieceId = t2;
    },
    AudioAssets: function AudioAssets(t0) {
      this._name = t0;
    },
    bootstrap(initializer, command, logger) {
      var com, runner, t1, t2, t3,
        sq = A.Squadron__getOrInitialize();
      $.Squadron__instance != null;
      sq._logger = logger;
      com = new MessageChannel();
      runner = new A.WorkerRunner(A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$.dynamic_Function_List_dynamic), new A.WorkerMonitor(new A.bootstrap_closure(com), A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.CancellationTokenReference)));
      t1 = com.port1;
      t1.toString;
      t2 = type$.nullable_void_Function_MessageEvent;
      t3 = type$.MessageEvent;
      A._EventStreamSubscription$(t1, "message", t2._as(A.JsWorkerRunnerExt_get_handle(runner)), false, t3);
      t1 = self;
      t1.toString;
      A._EventStreamSubscription$(type$.DedicatedWorkerGlobalScope._as(t1), "message", t2._as(new A.bootstrap_closure0(runner, com, initializer)), false, t3);
    },
    ...
    _JsWorkerChannel: function _JsWorkerChannel(t0) {
      this._sendPort = t0;
    },
    ...
    CancellationTokenReference: function CancellationTokenReference(t0, t1, t2) {
      ...
      _._refCount = 0;
      _.message = t1;
      _._cancellation_token$_id = t2;
      _._listeners = _._cancellation_token$_exception = null;
    },
    TokenId: function TokenId() {
      this.__token_id$_id = 0;
    },
    ...
    SquadronErrorExt_create(message, stackTrace) {
      var t1;
      A.Squadron_severe("SquadronError: " + message);
      t1 = new A.SquadronError(message, stackTrace);
      t1.SquadronError$_$2(message, stackTrace);
      return t1;
    },
    ...
    SquadronException_from(error, stackTrace) {
      ...
      } else if (error instanceof A.TaskTimeoutException) {
        t1 = error.message;
    ...
    Squadron__getOrInitialize() {
      ...
      if (sq == null) {
        sq = new A.Squadron(A._setArrayType([], type$.JSArray_int));
        sq._debugMode = $.Squadron___debugMode;
        $.Squadron__instance = sq;
      }
      return sq;
    },
    Squadron_debugMode() {
      var t1 = $.Squadron__instance;
      t1 = t1 == null ? null : t1._debugMode;
      return t1 == null ? $.Squadron___debugMode : t1;
    },
    ...
    CancellationToken_deserialize(token) {
      ...
      if (token == null)
        return null;
      t1 = J.getInterceptor$ax(token);
      return new A.CancellationToken(A._asStringQ(t1.$index(token, 1)), A._asString(t1.$index(token, 0)));
    },
    ...
    WorkerChannelExt_pipe(_this, stream, reply, monitor, tokenRef) {
      var t2, t3, t4, t5, t6, t1 = {};
      t1.subscription = null;
      t2 = new A._Future($.Zone__current, type$._Future_dynamic);
      t3 = new A.WorkerChannelExt_pipe_onDone(t1, _this, new A._AsyncCompleter(t2, type$._AsyncCompleter_dynamic));
      t4 = type$.void_Function;
      t4._as(t3);
      t5 = ++monitor._streamId;
      t6 = monitor._streamCancellers;
      if (t6 == null) {
        t4 = A.LinkedHashMap_LinkedHashMap$_empty(type$.int, t4);
        monitor.set$_streamCancellers(t4);
      } else
        t4 = t6;
      t4.$indexSet(0, t5, t3);
      if (tokenRef._hasRef)
        tokenRef.super$CancellationToken$addListener(0, t3);
      reply.call$1(t5);
      A.WorkerChannelExt_get__err(_this);
      t4 = stream.$ti;
      t4._eval$1("~(1)?")._as(reply);
      type$.nullable_void_Function._as(t3);
      t1.subscription = A._EventStreamSubscription$(stream._target, stream._eventType, reply, false, t4._precomputed1);
      return t2.whenComplete$1(new A.WorkerChannelExt_pipe_closure(monitor, tokenRef, t5));
    },
    WorkerChannelExt_get__err(_this) {
      return new A.WorkerChannelExt_get__err_closure(_this);
    },
    WorkerChannelExt_pipe_onDone: function WorkerChannelExt_pipe_onDone(t0, t1, t2) {
      this._box_0 = t0;
      this._this = t1;
      this.done = t2;
    },
    WorkerChannelExt_pipe_closure: function WorkerChannelExt_pipe_closure(t0, t1, t2) {
      this.monitor = t0;
      this.tokenRef = t1;
      this.streamId = t2;
    },
    WorkerChannelExt_get__err_closure: function WorkerChannelExt_get__err_closure(t0) {
      this._this = t0;
    },
    printString(string) {
    ...
    main() {
      A.bootstrap(A.shove_game_evaluator_service__$ShoveGameEvaluatorServiceInitializer$closure(), null, null);
    },
    ...
    Transferables__isSafeForTransfer(data) {
      if (data == null || typeof data == "string" || typeof data == "number" || A._isBool(data))
        return true;
            ...
            switch ($async$goto) {
              ...
              case 6:
                ...
                if (!J.every$1$ax(t3.get$keys(arg), A._transferables_Transferables__isBaseType$closure()))
                  A.throwExpression(A.SquadronErrorExt_create("Map keys must be strings, numbers or booleans.", A.StackTrace_current()));
    ...
    WorkerRequestExt_unwrapRequest(_this) {
      var ts,
        t1 = J.getInterceptor$ax(_this),
        t2 = t1.$index(_this, 1);
      t1.$indexSet(_this, 1, t2 == null ? null : new A._JsWorkerChannel(type$.MessagePort._as(t2)));
      t1.$indexSet(_this, 4, A.CancellationToken_deserialize(type$.nullable_List_dynamic._as(t1.$index(_this, 4))));
      if (t1.$index(_this, 7) == null)
        t1.$indexSet(_this, 7, false);
      if (t1.$index(_this, 3) == null)
        t1.$indexSet(_this, 3, B.List_empty);
      ts = t1.$index(_this, 0);
      if (ts != null)
        t1.$indexSet(_this, 0, A.Duration$(0, new A.DateTime(Date.now(), false).toUtc$0()._value - $.$get$_sqEpoch()._value)._duration - A._asInt(ts));
    },
    WorkerResponseExt_wrapResponse(_this) {
      var res, t1;
      if (1 >= _this.length)
        return A.ioore(_this, 1);
      res = _this[1];
      if (!type$.List_dynamic._is(res) && type$.Iterable_dynamic._is(res))
        B.JSArray_methods.$indexSet(_this, 1, J.toList$0$ax(res));
      if (2 >= _this.length)
      ...
      if (A.Squadron_debugMode())
        B.JSArray_methods.$indexSet(_this, 0, A.Duration$(0, new A.DateTime(Date.now(), false).toUtc$0()._value - $.$get$_sqEpoch()._value)._duration);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A._Record_2_isOver_winner.prototype = {$recipe: "+isOver,winner(1,2)", $shape: 2};
  ...
  A.MinMaxAi.prototype = {};
  A.RandomAi.prototype = {};
  A.IPlayer.prototype = {
    $eq(_, other) {
      if (other == null)
        return false;
      if (type$.IPlayer._is(other))
        return this.playerName === other.get$playerName() && this.isWhite === other.get$isWhite();
      return false;
    },
    get$hashCode(_) {
      return (B.JSString_methods.get$hashCode(this.playerName) ^ B.JSBool_methods.get$hashCode(this.isWhite)) >>> 0;
    },
    get$playerName() {
  ...
  A.ShoveGameMoveDto.prototype = {
    toJson$0() {
      var _this = this,
        t1 = B.Map_oy1Wi.$index(0, _this.shoveGameMoveType);
      t1.toString;
      return A.LinkedHashMap_LinkedHashMap$_literal(["oldSquare", _this.oldSquare, "newSquare", _this.newSquare, "shoveGameMoveType", t1, "madeBy", _this.madeBy, "throwerSquare", _this.throwerSquare], type$.String, type$.dynamic);
    }
  };
  A.ShoveGameStateDto.prototype = {
    toJson$0() {
      var _this = this,
        t1 = _this.gameOverState;
      t1 = t1 == null ? null : A.LinkedHashMap_LinkedHashMap$_literal(["isOver", t1._0, "winner", t1._1], type$.String, type$.nullable_Object);
      return A.LinkedHashMap_LinkedHashMap$_literal(["board", _this.board, "pieces", _this.pieces, "allMadeMoves", _this.allMadeMoves, "player1", _this.player1, "player2", _this.player2, "currentPlayersTurn", _this.currentPlayersTurn, "gameOverState", t1], type$.String, type$.dynamic);
    }
  };
  A._$ShoveGameStateDtoFromJson_closure.prototype = {
    call$2(k, e) {
      return new A.MapEntry(A._asString(k), A._$ShoveSquareDtoFromJson(type$.Map_String_dynamic._as(e)), type$.MapEntry_String_ShoveSquareDto);
    },
    $signature: 42
  };
  A._$ShoveGameStateDtoFromJson_closure0.prototype = {
    call$2(k, e) {
      var t1, t2;
      A._asString(k);
      t1 = type$.Map_String_dynamic;
      ...
      return new A.MapEntry(k, new A.ShovePieceDto(A._asString(t2.$index(e, "id")), A.$enumDecode(B.Map_xwIwp, t2.$index(e, "pieceType"), type$.PieceType, type$.String), A._asString(t2.$index(e, "texture")), A._asBool(t2.$index(e, "isIncapacitated")), A._$ShovePlayerDtoFromJson(t1._as(t2.$index(e, "owner")))), type$.MapEntry_String_ShovePieceDto);
    },
    $signature: 22
  };
  A._$ShoveGameStateDtoFromJson_closure1.prototype = {
    call$1(e) {
      var t2, t3, t4, t5, t6,
        _s13_ = "throwerSquare",
        t1 = type$.Map_String_dynamic;
      t1._as(e);
      t2 = J.getInterceptor$ax(e);
      t3 = A._$ShoveSquareDtoFromJson(t1._as(t2.$index(e, "oldSquare")));
      t4 = A._$ShoveSquareDtoFromJson(t1._as(t2.$index(e, "newSquare")));
      t5 = A.$enumDecode(B.Map_oy1Wi, t2.$index(e, "shoveGameMoveType"), type$.ShoveGameMoveType, type$.String);
      t6 = A._$ShovePlayerDtoFromJson(t1._as(t2.$index(e, "madeBy")));
      return new A.ShoveGameMoveDto(t3, t4, t5, t6, t2.$index(e, _s13_) == null ? null : A._$ShoveSquareDtoFromJson(t1._as(t2.$index(e, _s13_))));
    },
    $signature: 23
  };
  A._$ShoveGameStateDtoFromJson_closure2.prototype = {
    call$1($$jsonValue) {
      var t1 = J.getInterceptor$ax($$jsonValue),
        t2 = A._asBool(t1.$index($$jsonValue, "isOver"));
      return new A._Record_2_isOver_winner(t2, t1.$index($$jsonValue, "winner") == null ? null : A._$ShovePlayerDtoFromJson(type$.Map_String_dynamic._as(t1.$index($$jsonValue, "winner"))));
    },
    $signature: 24
  };
  A.ShovePieceDto.prototype = {
    toJson$0() {
      var _this = this,
        t1 = B.Map_xwIwp.$index(0, _this.pieceType);
      t1.toString;
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", _this.id, "pieceType", t1, "texture", _this.texture, "isIncapacitated", _this.isIncapacitated, "owner", _this.owner], type$.String, type$.dynamic);
    }
  };
  A.ShovePlayerDto.prototype = {
    toJson$0() {
      return A.LinkedHashMap_LinkedHashMap$_literal(["playerName", this.playerName, "isWhite", this.isWhite, "type", this.type], type$.String, type$.dynamic);
    },
    $eq(_, other) {
      var _this = this;
      if (other == null)
        return false;
      if (type$.IPlayer._is(other))
        return _this.playerName === other.get$playerName() && _this.isWhite === other.get$isWhite();
      if (other instanceof A.ShovePlayerDto)
        return _this.playerName === other.playerName && _this.isWhite === other.isWhite;
      return false;
    },
    get$hashCode(_) {
      return (B.JSString_methods.get$hashCode(this.playerName) ^ B.JSBool_methods.get$hashCode(this.isWhite)) >>> 0;
  ...
  A.ShoveSquareDto.prototype = {
    toJson$0() {
      return A.LinkedHashMap_LinkedHashMap$_literal(["x", this.x, "y", this.y, "pieceId", this.pieceId], type$.String, type$.dynamic);
    }
  };
  A.ShoveGameEvaluator.prototype = {
    minmax$7$alpha$beta$stateCalculationCache$stopwatch(game, maximizingPlayer, depth, alpha, beta, stateCalculationCache, stopwatch) {
      return this.minmax$body$ShoveGameEvaluator(game, maximizingPlayer, depth, alpha, beta, type$.HashMap_of_int_and_Record_2_double_and_nullable_ShoveGameMove._as(stateCalculationCache), stopwatch);
    },
    minmax$5$stateCalculationCache$stopwatch(game, maximizingPlayer, depth, stateCalculationCache, stopwatch) {
      return this.minmax$7$alpha$beta$stateCalculationCache$stopwatch(game, maximizingPlayer, depth, -1 / 0, 1 / 0, stateCalculationCache, stopwatch);
    },
    minmax$body$ShoveGameEvaluator(game, maximizingPlayer, depth, alpha, beta, stateCalculationCache, stopwatch) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Record_2_double_and_nullable_ShoveGameMove),
        $async$returnValue, $async$self = this, t1, bestScore, t2, t3, bestMove, _i, move, cacheKey, score;
      var $async$minmax$7$alpha$beta$stateCalculationCache$stopwatch = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (depth !== 0)
                if (!game.get$isGameOver()) {
                  t1 = B.JSInt_methods._tdivFast$1(A.Duration$(stopwatch.get$elapsedMicroseconds(), 0)._duration, 1000000);
                  t1 = t1 > 1;
                } else
                  t1 = true;
              else
                t1 = true;
              if (t1) {
                $async$returnValue = new A._Record_2($async$self.evaluateGameState$2(game, maximizingPlayer), null);
                // goto return
                $async$goto = 1;
                break;
              }
              bestScore = maximizingPlayer.$eq(0, game.currentPlayersTurn) ? -1 / 0 : 1 / 0;
              t1 = game.getAllLegalMoves$0(), t2 = t1.length, t3 = depth - 1, bestMove = null, _i = 0;
            case 3:
              // for condition
              if (!(_i < t1.length)) {
                // goto after for
              ...
              move = t1[_i];
              game.move$1(move);
              cacheKey = game.calculateBoardStateHash$0();
              if (stateCalculationCache.containsKey$1(0, cacheKey)) {
                t1 = stateCalculationCache.$index(0, cacheKey);
                t1.toString;
                game.undoLastMove$0();
              ...
              $async$goto = 6;
              return A._asyncAwait($async$self.minmax$7$alpha$beta$stateCalculationCache$stopwatch(game, maximizingPlayer, t3, alpha, beta, stateCalculationCache, stopwatch), $async$minmax$7$alpha$beta$stateCalculationCache$stopwatch);
            case 6:
              // returning from await.
              score = $async$result._0;
              stateCalculationCache.$indexSet(0, cacheKey, new A._Record_2(score, move));
              game.undoLastMove$0();
              if (maximizingPlayer.$eq(0, game.currentPlayersTurn)) {
                if (score > bestScore) {
                  bestScore = score;
                  bestMove = move;
                }
            ...
            case 5:
              // after for
              $async$returnValue = new A._Record_2(bestScore, bestMove);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$minmax$7$alpha$beta$stateCalculationCache$stopwatch, $async$completer);
    },
    evaluateGameState$2(game, maximizingPlayer) {
      var t1, score, t2, t3, t4, t5, squareHasPiece, isMaximizingPlayersPiece, isOpponentsPiece, t6, t7, t8, pieceDistancetoOpponentGoal, countThrowableNeighbors, countBlockableNeighbors, countShoveableNeighbors, _null = null;
      if (game.get$isGameOver()) {
        t1 = game.gameOverState;
        score = J.$eq$(t1 == null ? _null : t1._1, maximizingPlayer) ? 1 / 0 : -1 / 0;
        t1 = game.gameOverState;
        if ((t1 == null ? _null : t1._1) == null)
          score = -500;
      } else
        score = 0;
      for (t1 = game.board, t1 = t1.get$values(t1), t2 = A._instanceType(t1), t2 = t2._eval$1("@<1>")._bind$1(t2._rest[1]), t1 = new A.MappedIterator(J.get$iterator$ax(t1.__internal$_iterable), t1._f, t2._eval$1("MappedIterator<1,2>")), t2 = t2._rest[1], t3 = game.pieces; t1.moveNext$0();) {
        t4 = t1.__internal$_current;
        if (t4 == null)
          t4 = t2._as(t4);
        t5 = t4.pieceId;
        squareHasPiece = t5 != null ? t3.$index(0, t5) : _null;
        t5 = squareHasPiece == null;
        isMaximizingPlayersPiece = J.$eq$(t5 ? _null : squareHasPiece.owner, maximizingPlayer) && !t5;
        isOpponentsPiece = !J.$eq$(t5 ? _null : squareHasPiece.owner, maximizingPlayer) && !t5;
        t6 = t5 ? _null : squareHasPiece.pieceType;
        t7 = t5 ? _null : squareHasPiece.pieceType;
        t8 = t5 ? _null : squareHasPiece.pieceType;
        if (!t5 && t8 !== B.PieceType_3_leaper) {
        ...
        if (t6 === B.PieceType_5_thrower) {
          t6 = game.getAllNeighborSquares$1(t4);
          t8 = A._arrayInstanceType(t6);
          t8 = new A.WhereIterable(t6, t8._eval$1("bool(1)")._as(new A.ShoveGameEvaluator_evaluateGameState_closure(game)), t8._eval$1("WhereIterable<1>"));
          countThrowableNeighbors = t8.get$length(t8);
          score += isMaximizingPlayersPiece ? countThrowableNeighbors * 2 : -countThrowableNeighbors * 2;
        }
        if ((t5 ? _null : squareHasPiece.pieceType) === B.PieceType_1_blocker) {
          t5 = game.getAllNeighborSquares$1(t4);
          t6 = A._arrayInstanceType(t5);
          t6 = new A.WhereIterable(t5, t6._eval$1("bool(1)")._as(new A.ShoveGameEvaluator_evaluateGameState_closure0(game)), t6._eval$1("WhereIterable<1>"));
          countBlockableNeighbors = t6.get$length(t6);
          score += isMaximizingPlayersPiece ? countBlockableNeighbors : -countBlockableNeighbors;
        }
        if (t7 === B.PieceType_2_shover) {
          t4 = game.getAllNeighborSquares$1(t4);
          t5 = A._arrayInstanceType(t4);
          t5 = new A.WhereIterable(t4, t5._eval$1("bool(1)")._as(new A.ShoveGameEvaluator_evaluateGameState_closure1(game)), t5._eval$1("WhereIterable<1>"));
          countShoveableNeighbors = t5.get$length(t5);
          score += isMaximizingPlayersPiece ? countShoveableNeighbors : -countShoveableNeighbors;
        }
      }
      return score;
    }
  ...
  A.ShoveGameEvaluator_evaluateGameState_closure.prototype = {
    call$1(element) {
      ...
      if (element.pieceId != null) {
        ...
        t3 = t1.player1;
        t1 = J.$eq$(t2, piece.owner.$eq(0, t3) ? t1.player2 : t3) && piece.pieceType !== B.PieceType_1_blocker;
      } else
        t1 = false;
      return t1;
    },
  ...
  A.ShoveGameEvaluator_evaluateGameState_closure0.prototype = {
    call$1(element) {
      var t2, t3,
        t1 = this.game,
        piece = t1.pieces.$index(0, type$.ShoveSquare._as(element).pieceId);
      if (piece != null) {
        t2 = piece.owner;
        t3 = t1.player1;
        t1 = t2.$eq(0, t2.$eq(0, t3) ? t1.player2 : t3) && piece.pieceType !== B.PieceType_1_blocker;
      } else
        t1 = false;
      return t1;
    },
  ...
  A.ShoveGameEvaluator_evaluateGameState_closure1.prototype = {
    call$1(element) {
      var t2, t3,
        t1 = this.game,
        piece = t1.pieces.$index(0, type$.ShoveSquare._as(element).pieceId);
  ...
  A.ShoveGameEvaluatorService.prototype = {
    evaluateGameState$2(shoveGameJson, shovePlayerJson) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.double),
        $async$returnValue;
      var $async$evaluateGameState$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = A.ShoveGameEvaluatorService__evaluateGameState(shoveGameJson, shovePlayerJson);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$evaluateGameState$2, $async$completer);
    },
    findBestMove$1(shoveGameJson) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.nullable_String),
        $async$returnValue;
      var $async$findBestMove$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = A.ShoveGameEvaluatorService__findBestMove(shoveGameJson);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$findBestMove$1, $async$completer);
    }
  };
  A._$ShoveGameEvaluatorServiceWorkerService.prototype = {
    get$_shove_game_evaluator_service$_operations() {
      var t1, t2, result, _this = this,
        value = _this.___$ShoveGameEvaluatorServiceWorkerService__operations_FI;
      if (value === $) {
        t1 = type$.int;
        t2 = type$.dynamic_Function_List_dynamic;
        result = A.ConstantMap_ConstantMap$from(A.LinkedHashMap_LinkedHashMap$_literal([1, new A._$ShoveGameEvaluatorServiceWorkerService__operations_closure(_this), 2, new A._$ShoveGameEvaluatorServiceWorkerService__operations_closure0(_this)], t1, t2), t1, t2);
        _this.___$ShoveGameEvaluatorServiceWorkerService__operations_FI !== $ && A.throwLateFieldADI("_operations");
        _this.set$___$ShoveGameEvaluatorServiceWorkerService__operations_FI(result);
        value = result;
      }
      return value;
    },
    set$___$ShoveGameEvaluatorServiceWorkerService__operations_FI(___$ShoveGameEvaluatorServiceWorkerService__operations_FI) {
      this.___$ShoveGameEvaluatorServiceWorkerService__operations_FI = type$.Map_of_int_and_dynamic_Function_List_dynamic._as(___$ShoveGameEvaluatorServiceWorkerService__operations_FI);
    },
    $isWorkerService: 1
  };
  A._$ShoveGameEvaluatorServiceWorkerService__operations_closure.prototype = {
    call$1($$) {
      var t2,
        t1 = type$.List_dynamic;
      t1._as($$);
      t2 = J.getInterceptor$ax($$);
      return this.$this.evaluateGameState$2(A._asString(J.$index$ax(t1._as(t2.$index($$, 3)), 0)), A._asString(J.$index$ax(t1._as(t2.$index($$, 3)), 1)));
    },
    $signature: 26
  };
  A._$ShoveGameEvaluatorServiceWorkerService__operations_closure0.prototype = {
    call$1($$) {
      var t1 = type$.List_dynamic;
      return this.$this.findBestMove$1(A._asString(J.$index$ax(t1._as(J.$index$ax(t1._as($$), 3)), 0)));
    },
    $signature: 27
  };
  A.PieceType.prototype = {
    _enumToString$0() {
      return "PieceType." + this._name;
    }
  };
  A.ShoveDirection.prototype = {
    _enumToString$0() {
      return "ShoveDirection." + this._name;
    }
  };
  A.ShoveGame.prototype = {
    get$isGameOver() {
      var t1 = this.gameOverState;
      return (t1 == null ? null : t1._0) === true;
    },
    get$isDraw() {
      var t1 = this.gameOverState,
        t2 = t1 == null;
      if ((t2 ? null : t1._1) == null)
        t1 = (t2 ? null : t1._0) === true;
      else
        t1 = false;
      return t1;
    },
    ShoveGame$5$currentPlayersTurn$customBoard$customPieces(player1, player2, currentPlayersTurn, customBoard, customPieces) {
      var t1, t2, t3, currentCol, t4;
      for (t1 = this.player1GoalShoveSquares, t2 = this.board, t3 = this.player2GoalShoveSquares, currentCol = 0; currentCol < 7; ++currentCol) {
        t4 = t2.$index(0, new A._Record_2(0, currentCol));
        t4.toString;
        B.JSArray_methods.add$1(t1, t4);
        t4 = t2.$index(0, new A._Record_2(7, currentCol));
        t4.toString;
        B.JSArray_methods.add$1(t3, t4);
      }
    },
    validateThrow$3(thrower, thrownFromSquare, thrownToSquare) {
      var throwerIsThrowerAndNotIncapacitated, throwerBelongsToCurrentPlayer, t2, t3, t4, thrownPieceIsNextToFriendlyBlocker, t5, _this = this, _null = null,
        t1 = _this.pieces,
        throwerPiece = t1.$index(0, thrower.pieceId),
        thrownFromSquarePiece = t1.$index(0, thrownFromSquare.pieceId);
      t1 = throwerPiece == null;
      if ((t1 ? _null : throwerPiece.pieceType) === B.PieceType_5_thrower)
        throwerIsThrowerAndNotIncapacitated = (t1 ? _null : throwerPiece.isIncapacitated) === false;
      else
        throwerIsThrowerAndNotIncapacitated = false;
      t1 = t1 ? _null : throwerPiece.owner;
      throwerBelongsToCurrentPlayer = J.$eq$(t1, _this.currentPlayersTurn);
      t1 = thrownFromSquarePiece == null;
      t2 = t1 ? _null : thrownFromSquarePiece.owner;
      t2 = J.$eq$(t2, _this.currentPlayersTurn);
      t3 = t1 ? _null : thrownFromSquarePiece.isIncapacitated;
      t4 = thrownToSquare.pieceId;
      thrownPieceIsNextToFriendlyBlocker = B.JSArray_methods.any$1(_this.getAllNeighborSquares$1(thrownFromSquare), new A.ShoveGame_validateThrow_closure(_this));
      t5 = thrower.$eq(0, thrownFromSquare);
      if (thrownPieceIsNextToFriendlyBlocker)
        return false;
      if (!throwerIsThrowerAndNotIncapacitated)
        return false;
      if (!throwerBelongsToCurrentPlayer || t2)
        return false;
      if (t5)
        return false;
      if (t3 !== false)
        return false;
      if (Math.abs(thrower.x - thrownToSquare.x) > 1)
        return false;
      if (Math.abs(thrower.y - thrownToSquare.y) > 1)
        return false;
      if ((t1 ? _null : thrownFromSquarePiece.pieceType) === B.PieceType_1_blocker)
        return false;
      if (t4 != null)
        return false;
      return true;
    },
    validateMove$1(shoveGameMove) {
      var t4, t5, t6, t7, direction, _this = this, _null = null,
        t1 = _this.pieces,
        t2 = shoveGameMove.oldSquare,
        oldSquarePiece = t1.$index(0, t2.pieceId),
        t3 = shoveGameMove.newSquare,
        newSquarePiece = t1.$index(0, t3.pieceId);
      t1 = t2.x;
      t4 = t3.x;
      if (t1 === t4 && t2.y === t3.y)
        return false;
      if (t2.pieceId == null)
        return false;
      t5 = oldSquarePiece == null;
      t6 = t5 ? _null : oldSquarePiece.isIncapacitated;
      if (t6 === true)
        return false;
      if (shoveGameMove.shoveGameMoveType === B.ShoveGameMoveType_1) {
        t1 = shoveGameMove.throwerSquare;
        t1.toString;
        return _this.validateThrow$3(t1, t2, t3);
      }
      t5 = t5 ? _null : oldSquarePiece.owner;
      if (!J.$eq$(t5, _this.currentPlayersTurn))
        return false;
      t5 = t3.y;
      if (_this.isOutOfBounds$2(t4, t5))
        return false;
      switch (oldSquarePiece.pieceType) {
        case B.PieceType_2_shover:
          t1 -= t4;
          t6 = Math.abs(t1);
          if (t6 > 1)
            return false;
          ...
          if (t6 && t7 > 0)
            return false;
          if (oldSquarePiece.owner.isWhite) {
            if (t1 < 0)
              return false;
          } else if (t1 > 0)
            return false;
          if ((newSquarePiece == null ? _null : newSquarePiece.pieceType) === B.PieceType_1_blocker)
            return false;
          if (t6 && t7 > 0)
            return false;
          direction = _this.calculateShoveDirection$2(t2, t3);
          if (direction == null)
            return false;
          t1 = _this.board.$index(0, new A._Record_2(t4, t5));
          if ((t1 == null ? _null : t1.pieceId) != null)
            if (_this.shoveResultsInCollision$3(direction, t4, t5))
              return false;
          break;
        case B.PieceType_1_blocker:
          t3 = Math.abs(t1 - t4);
          if (t3 > 0 && Math.abs(t2.y - t5) > 0)
            return false;
          if (t3 > 2 || Math.abs(t2.y - t5) > 2)
            return false;
          if (t3 > 1 || Math.abs(t2.y - t5) > 1)
            if (_this.board.$index(0, new A._Record_2(B.JSInt_methods._tdivFast$1(t1 + t4, 2), B.JSInt_methods._tdivFast$1(t2.y + t5, 2))).pieceId != null)
              return false;
          t1 = _this.board.$index(0, new A._Record_2(t4, t5));
          if ((t1 == null ? _null : t1.pieceId) != null)
            return false;
          break;
        case B.PieceType_3_leaper:
          t3 = Math.abs(t1 - t4);
          if (t3 > 0 && Math.abs(t2.y - t5) > 0)
            return false;
          t6 = _this.board;
          t7 = t6.$index(0, new A._Record_2(t4, t5));
          if ((t7 == null ? _null : t7.pieceId) != null)
            return false;
          t2 = t2.y;
          if (t6.$index(0, new A._Record_2(B.JSInt_methods._tdivFast$1(t1 + t4, 2), B.JSInt_methods._tdivFast$1(t2 + t5, 2))).pieceId == null) {
            if (t3 > 1 || Math.abs(t2 - t5) > 1)
              return false;
          } else if (t3 > 2 || Math.abs(t2 - t5) > 2)
            return false;
          break;
        case B.PieceType_5_thrower:
          if (Math.abs(t1 - t4) > 1 || Math.abs(t2.y - t5) > 1)
            return false;
          t1 = _this.board.$index(0, new A._Record_2(t4, t5));
          if ((t1 == null ? _null : t1.pieceId) != null)
            return false;
          break;
        default:
          throw A.wrapException(A.Exception_Exception("Piece type not implemented"));
      }
      t1 = newSquarePiece == null ? _null : newSquarePiece.owner;
      if (J.$eq$(t1, oldSquarePiece.owner))
        return false;
      return true;
    },
    isOutOfBounds$2(x, y) {
    ...
    move$1(shoveGameMove) {
      var t3, shoveDirection, audioToPlay, piece, _this = this, _null = null,
        opponentSquare = shoveGameMove.newSquare,
        t1 = _this.pieces,
        t2 = shoveGameMove.oldSquare,
        oldSquarePiece = t1.$index(0, t2.pieceId);
      if (opponentSquare.pieceId != null)
        t3 = (oldSquarePiece == null ? _null : oldSquarePiece.pieceType) === B.PieceType_2_shover;
      else
        t3 = false;
      if (t3) {
        shoveDirection = _this.calculateShoveDirection$2(t2, opponentSquare);
        if (shoveDirection == null)
          throw A.wrapException(A.Exception_Exception(A.S(oldSquarePiece == null ? _null : oldSquarePiece.owner.playerName) + " made an invalid move!"));
        switch (shoveDirection) {
          case B.ShoveDirection_0:
            audioToPlay = shoveGameMove.shove$4(opponentSquare.x + 1, opponentSquare.y, opponentSquare, _this);
            break;
          case B.ShoveDirection_1:
            audioToPlay = shoveGameMove.shove$4(opponentSquare.x - 1, opponentSquare.y, opponentSquare, _this);
            break;
          case B.ShoveDirection_3:
            audioToPlay = shoveGameMove.shove$4(opponentSquare.x, opponentSquare.y + 1, opponentSquare, _this);
            break;
          case B.ShoveDirection_2:
            audioToPlay = shoveGameMove.shove$4(opponentSquare.x, opponentSquare.y - 1, opponentSquare, _this);
            break;
          default:
            audioToPlay = _null;
        ...
        audioToPlay = _null;
      if ((oldSquarePiece == null ? _null : oldSquarePiece.pieceType) === B.PieceType_3_leaper) {
        t3 = _this.board.$index(0, new A._Record_2(B.JSInt_methods._tdivFast$1(t2.x + opponentSquare.x, 2), B.JSInt_methods._tdivFast$1(t2.y + opponentSquare.y, 2)));
        piece = t1.$index(0, t3.pieceId);
        if (piece != null)
          piece.isIncapacitated = true;
        shoveGameMove.leapedOverSquare = t3;
      }
      if (shoveGameMove.shoveGameMoveType === B.ShoveGameMoveType_1)
        audioToPlay = shoveGameMove.throwPiece$1(_this);
      else {
        t1 = _this.board;
        t1.$index(0, new A._Record_2(opponentSquare.x, opponentSquare.y)).pieceId = t2.pieceId;
        t1.$index(0, new A._Record_2(t2.x, t2.y)).pieceId = null;
        if (audioToPlay == null)
          audioToPlay = B.AudioAssets_move;
      }
      shoveGameMove.revertIncapacition$1(_this);
      _this.currentPlayersTurn = _this.currentPlayersTurn.isWhite ? _this.player2 : _this.player1;
      B.JSArray_methods.add$1(_this.allMadeMoves, shoveGameMove);
      _this.checkIfGameIsOver$0();
      return audioToPlay;
    },
    calculateShoveDirection$2(oldSquare, newSquare) {
      var t1 = newSquare.x,
        t2 = oldSquare.x;
      if (t1 > t2)
        return B.ShoveDirection_0;
      else if (t1 < t2)
        return B.ShoveDirection_1;
      t1 = newSquare.y;
      t2 = oldSquare.y;
      if (t1 > t2)
        return B.ShoveDirection_3;
      else if (t1 < t2)
        return B.ShoveDirection_2;
      return null;
    },
    shoveResultsInCollision$3(direction, x, y) {
      var t1, _this = this, _null = null;
      switch (direction) {
        case B.ShoveDirection_0:
          t1 = _this.board.$index(0, new A._Record_2(x + 1, y));
          t1 = (t1 == null ? _null : t1.pieceId) != null;
          break;
        case B.ShoveDirection_1:
          t1 = _this.board.$index(0, new A._Record_2(x - 1, y));
          t1 = (t1 == null ? _null : t1.pieceId) != null;
          break;
        case B.ShoveDirection_3:
          t1 = _this.board.$index(0, new A._Record_2(x, y + 1));
          t1 = (t1 == null ? _null : t1.pieceId) != null;
          break;
        case B.ShoveDirection_2:
          t1 = _this.board.$index(0, new A._Record_2(x, y - 1));
    ...
    checkIfGameIsOver$0() {
      var player1HasPieceInGoal, player2HasPieceInGoal, _this = this,
        t1 = new A.ShoveGame_checkIfGameIsOver_checkIfPlayerHasRepeatedSameMoveThreeTimes(_this, new A.ShoveGame_checkIfGameIsOver_listEquals()),
        winningPlayer = _this.player1,
        player1Repeated = t1.call$1(winningPlayer),
        t2 = _this.player2,
        player2Repeated = t1.call$1(t2);
      if (player1Repeated && player2Repeated)
        return _this.gameOverState = new A._Record_2_isOver_winner(true, null);
      player1HasPieceInGoal = B.JSArray_methods.any$1(_this.player1GoalShoveSquares, new A.ShoveGame_checkIfGameIsOver_closure(_this));
      player2HasPieceInGoal = B.JSArray_methods.any$1(_this.player2GoalShoveSquares, new A.ShoveGame_checkIfGameIsOver_closure0(_this));
      if (!player1HasPieceInGoal)
        winningPlayer = player2HasPieceInGoal ? t2 : null;
      return _this.gameOverState = new A._Record_2_isOver_winner(winningPlayer != null, winningPlayer);
    },
    getAllLegalMoves$0() {
      var t1, t2, t3, t4, x, y, t5, neighbors, t6, _i, neighbor, t7, _this = this,
        legals = A._setArrayType([], type$.JSArray_ShoveGameMove);
      for (t1 = _this.board, t2 = t1.get$values(t1), t3 = A._instanceType(t2), t3 = t3._eval$1("@<1>")._bind$1(t3._rest[1]), t2 = new A.MappedIterator(J.get$iterator$ax(t2.__internal$_iterable), t2._f, t3._eval$1("MappedIterator<1,2>")), t3 = t3._rest[1]; t2.moveNext$0();) {
        ...
        if (t4.pieceId != null)
          for (x = 0; x < 8; ++x)
            for (y = 0; y < 8; ++y) {
              t5 = t1.$index(0, new A._Record_2(x, y));
              if (t5 == null)
                continue;
              neighbors = _this.getAllNeighborSquares$1(t4);
              t6 = _this.currentPlayersTurn;
              if (_this.validateMove$1(new A.ShoveGameMove(t4, t5, B.ShoveGameMoveType_0, t6, null))) {
                t6 = _this.currentPlayersTurn;
                B.JSArray_methods.add$1(legals, new A.ShoveGameMove(t4, t5, B.ShoveGameMoveType_0, t6, null));
              }
              for (t6 = neighbors.length, _i = 0; _i < neighbors.length; neighbors.length === t6 || (0, A.throwConcurrentModificationError)(neighbors), ++_i) {
                neighbor = neighbors[_i];
                t7 = _this.currentPlayersTurn;
                if (_this.validateMove$1(new A.ShoveGameMove(t4, t5, B.ShoveGameMoveType_1, t7, neighbor))) {
                  t7 = _this.currentPlayersTurn;
                  B.JSArray_methods.add$1(legals, new A.ShoveGameMove(t4, t5, B.ShoveGameMoveType_1, t7, neighbor));
                }
              }
            }
      }
    ...
    undoLastMove$0() {
      var lastMove, t3, t4, t5, t6, piece, _this = this,
        t1 = _this.allMadeMoves,
        t2 = t1.length;
      if (t2 === 0)
        return;
      if (0 >= t2)
        return A.ioore(t1, -1);
      lastMove = t1.pop();
      t1 = lastMove.oldSquare;
      t2 = _this.board;
      t3 = t2.$index(0, new A._Record_2(t1.x, t1.y));
      t4 = lastMove.newSquare;
      t3.pieceId = t4.pieceId;
      t3 = t4.x;
      t5 = t4.y;
      t2.$index(0, new A._Record_2(t3, t5)).pieceId = null;
      t6 = lastMove.shovedPiece;
      if (t6 != null) {
        lastMove._revertPieceOutOfBounds$2(_this, t6);
        t6 = lastMove.shovedPiece;
        if (t6 != null)
          t6.isIncapacitated = false;
        t6 = lastMove.shovedToSquare;
        if (t6 != null)
          t6.pieceId = null;
        t2 = t2.$index(0, new A._Record_2(t3, t5));
        t2.toString;
        t3 = lastMove.shovedPiece;
        t2.pieceId = t3 == null ? null : t3.id;
      }
      t2 = lastMove.leapedOverSquare;
      if (t2 != null) {
        t2 = t2.pieceId;
        piece = _this.pieces.$index(0, t2);
        if (piece != null)
          piece.isIncapacitated = false;
      }
      t2 = lastMove.thrownPiece;
      if (t2 != null) {
        lastMove._revertPieceOutOfBounds$2(_this, t2);
        t2 = lastMove.thrownPiece;
        t2.isIncapacitated = false;
        t2 = t2.id;
        t1.pieceId = t2;
        t4.pieceId = null;
      }
    ...
    getAllNeighborSquares$1(square) {
      var t1, x, t2, t3, y, t4, t5, t6, y0, t7,
        neighbors = A._setArrayType([], type$.JSArray_ShoveSquare);
      for (t1 = square.x, x = t1 - 1, t2 = t1 + 1, t3 = square.y, y = t3 - 1, t4 = t3 + 1, t5 = this.board; x <= t2; ++x)
        for (t6 = x === t1, y0 = y; y0 <= t4; ++y0) {
          if (t6 && y0 === t3)
            continue;
          t7 = t5.$index(0, new A._Record_2(x, y0));
          if (t7 != null)
            B.JSArray_methods.add$1(neighbors, t7);
        }
      return neighbors;
    },
    getSquaresDistanceToGoal$2(owner, square) {
      var t1 = square.x;
      if (owner.$eq(0, this.player1))
        return Math.abs(B.JSArray_methods.get$first(this.player1GoalShoveSquares).x - t1);
      else
        return Math.abs(B.JSArray_methods.get$first(this.player2GoalShoveSquares).x - t1);
    },
    calculateBoardStateHash$0() {
      var t1, t2, hash, t3, t4, _this = this;
      for (t1 = _this.pieces, t1 = t1.get$values(t1), t2 = A._instanceType(t1), t2 = t2._eval$1("@<1>")._bind$1(t2._rest[1]), t1 = new A.MappedIterator(J.get$iterator$ax(t1.__internal$_iterable), t1._f, t2._eval$1("MappedIterator<1,2>")), t2 = t2._rest[1], hash = 7; t1.moveNext$0();) {
        t3 = t1.__internal$_current;
        if (t3 == null)
          t3 = t2._as(t3);
        t4 = A.Primitives_objectHashCode(t3.pieceType);
        t3 = t3.owner;
        hash = 31 * hash + ((t4 ^ B.JSString_methods.get$hashCode(t3.playerName) ^ B.JSBool_methods.get$hashCode(t3.isWhite)) >>> 0);
      }
      t1 = _this.currentPlayersTurn;
      hash = 31 * hash + ((B.JSString_methods.get$hashCode(t1.playerName) ^ B.JSBool_methods.get$hashCode(t1.isWhite)) >>> 0);
      if (_this.get$isGameOver()) {
        t1 = _this.get$isGameOver() ? 1 : 0;
        hash = 31 * hash + t1;
      }
      if (_this.get$isDraw()) {
        t1 = _this.get$isDraw() ? 1 : 0;
        hash = 31 * hash + t1;
      }
      for (t1 = _this.board, t1 = t1.get$values(t1), t2 = A._instanceType(t1), t2 = t2._eval$1("@<1>")._bind$1(t2._rest[1]), t1 = new A.MappedIterator(J.get$iterator$ax(t1.__internal$_iterable), t1._f, t2._eval$1("MappedIterator<1,2>")), t2 = t2._rest[1]; t1.moveNext$0();) {
        t3 = t1.__internal$_current;
        if (t3 == null)
          t3 = t2._as(t3);
        hash = 31 * hash + (B.JSInt_methods.get$hashCode(t3.x) ^ B.JSInt_methods.get$hashCode(t3.y) ^ J.get$hashCode$(t3.pieceId));
      }
      return hash;
    }
  };
  A.ShoveGame_ShoveGame$fromDto_closure.prototype = {
    call$2(key, value) {
      var t1, t2;
      A._asString(key);
      type$.ShoveSquareDto._as(value);
      t1 = key.split(",");
      if (0 >= t1.length)
        return A.ioore(t1, 0);
      t1 = A.int_parse(t1[0]);
      ...
      if (1 >= t2.length)
        return A.ioore(t2, 1);
      return new A.MapEntry(new A._Record_2(t1, A.int_parse(t2[1])), new A.ShoveSquare(value.x, value.y, value.pieceId), type$.MapEntry_of_Record_2_int_and_int_and_ShoveSquare);
    },
    $signature: 35
  };
  ...
  A.ShoveGame_ShoveGame$fromDto_closure1.prototype = {
    call$1(e) {
      var t1, t2, t3, t4, t5;
      type$.ShoveGameMoveDto._as(e);
      t1 = e.oldSquare;
      t2 = e.newSquare;
      t3 = A.IPlayer_IPlayer$fromDto(e.madeBy);
      t4 = e.throwerSquare;
      t4 = t4 != null ? new A.ShoveSquare(t4.x, t4.y, t4.pieceId) : null;
      t5 = t4 != null ? B.ShoveGameMoveType_1 : B.ShoveGameMoveType_0;
      return new A.ShoveGameMove(new A.ShoveSquare(t1.x, t1.y, t1.pieceId), new A.ShoveSquare(t2.x, t2.y, t2.pieceId), t5, t3, t4);
    },
    $signature: 30
  };
  A.ShoveGame_validateThrow_closure.prototype = {
    call$1(element) {
      var t1 = this.$this,
        piece = t1.pieces.$index(0, type$.ShoveSquare._as(element).pieceId),
        t2 = piece == null;
      if ((t2 ? null : piece.pieceType) === B.PieceType_1_blocker) {
        t2 = t2 ? null : piece.owner;
        t1 = !J.$eq$(t2, t1.currentPlayersTurn);
      } else
        t1 = false;
      return t1;
    },
  ...
  A.ShoveGame_checkIfGameIsOver_listEquals.prototype = {
    call$1$2(list1, list2, $T) {
      var i,
        t1 = $T._eval$1("List<0>");
      t1._as(list1);
      t1._as(list2);
    ...
    call$2(list1, list2) {
      return this.call$1$2(list1, list2, type$.dynamic);
    },
    $signature: 31
  };
  A.ShoveGame_checkIfGameIsOver_checkIfPlayerHasRepeatedSameMoveThreeTimes.prototype = {
    call$1(player) {
      var t2, t3, playerMoves, lastThreeMoves, t4, i, t5, t6, sequence,
        t1 = this.$this.allMadeMoves;
      if (t1.length < 9)
        return false;
      t2 = A._arrayInstanceType(t1);
      t3 = t2._eval$1("WhereIterable<1>");
      playerMoves = A.List_List$of(new A.WhereIterable(t1, t2._eval$1("bool(1)")._as(new A.ShoveGame_checkIfGameIsOver_checkIfPlayerHasRepeatedSameMoveThreeTimes_closure(player)), t3), true, t3._eval$1("Iterable.E"));
      if (playerMoves.length < 3)
        return false;
      t1 = A._arrayInstanceType(playerMoves);
      t2 = t1._eval$1("ReversedListIterable<1>");
      lastThreeMoves = A.SubListIterable$(new A.ReversedListIterable(playerMoves, t2), 0, A.checkNotNullable(3, "count", type$.int), t2._eval$1("ListIterable.E")).toList$0(0);
      for (t2 = this.listEquals, t3 = type$.ShoveGameMove, t4 = t1._precomputed1, t1 = t1._eval$1("SubListIterable<1>"), i = 0; t5 = playerMoves.length, i < t5 - 3; ++i) {
        t6 = i + 3;
        A.RangeError_checkValidRange(i, t6, t5);
        sequence = new A.SubListIterable(playerMoves, i, t6, t1);
        sequence.SubListIterable$3(playerMoves, i, t6, t4);
        if (A.boolConversionCheck(t2.call$1$2(sequence.toList$0(0), lastThreeMoves, t3)))
          return true;
      }
      return false;
    },
  ...
  A.ShoveGame_checkIfGameIsOver_checkIfPlayerHasRepeatedSameMoveThreeTimes_closure.prototype = {
    call$1(move) {
      return type$.ShoveGameMove._as(move).madeBy.$eq(0, this.player);
    },
    $signature: 33
  };
  A.ShoveGame_checkIfGameIsOver_closure.prototype = {
    call$1(element) {
      var t1 = this.$this,
        piece = t1.pieces.$index(0, type$.ShoveSquare._as(element).pieceId),
        t2 = piece == null,
        t3 = t2 ? null : piece.owner;
      if (J.$eq$(t3, t1.player1))
        t1 = (t2 ? null : piece.pieceType) === B.PieceType_2_shover;
      else
        t1 = false;
      return t1;
    },
  ...
  A.ShoveGame_checkIfGameIsOver_closure0.prototype = {
    call$1(element) {
      var t1 = this.$this,
        piece = t1.pieces.$index(0, type$.ShoveSquare._as(element).pieceId),
        t2 = piece == null,
        t3 = t2 ? null : piece.owner;
      if (J.$eq$(t3, t1.player2))
        t1 = (t2 ? null : piece.pieceType) === B.PieceType_2_shover;
      else
        t1 = false;
      return t1;
  ...
  A.ShoveGameMove.prototype = {
    _revertPieceOutOfBounds$2(shoveGame, piece) {
      var t1 = shoveGame.pieces,
        t2 = piece.id;
      if (t1.$index(0, t2) == null)
        t1.$indexSet(0, t2, piece);
    },
    shove$4(x, y, shovedSquare, shoveGame) {
      var audioToPlay,
        t1 = shoveGame.pieces,
        piece = t1.$index(0, shovedSquare.pieceId);
      if (shoveGame.isOutOfBounds$2(x, y)) {
        piece.toString;
        t1.remove$1(0, piece);
        audioToPlay = B.AudioAssets_scream;
      } else {
        if (piece != null)
          piece.isIncapacitated = true;
        t1 = shoveGame.board.$index(0, new A._Record_2(x, y));
        if (t1 != null)
          t1.pieceId = shovedSquare.pieceId;
        this.shovedToSquare = t1;
        audioToPlay = B.AudioAssets_bonk;
      }
      this.shovedPiece = piece;
      shovedSquare.pieceId = null;
      return audioToPlay;
    },
    throwPiece$1(shoveGame) {
      var t3, t4, t5, t6, t7, t8, t9, _this = this,
        t1 = shoveGame.pieces,
        t2 = _this.oldSquare;
      _this.set$thrownPiece(t1.$index(0, t2.pieceId));
      t3 = _this.newSquare;
      t4 = t3.x;
      t3 = t3.y;
      t5 = shoveGame.isOutOfBounds$2(t4, t3);
      t6 = _this.thrownPiece;
      t7 = t2.x;
      t8 = t2.y;
      t9 = shoveGame.board;
      if (t5) {
        t6.toString;
        t1.remove$1(0, t6);
        t9.$index(0, new A._Record_2(t7, t8)).pieceId = null;
        return B.AudioAssets_scream;
      } else {
        t6.isIncapacitated = true;
        t9.$index(0, new A._Record_2(t4, t3)).pieceId = t2.pieceId;
        t9.$index(0, new A._Record_2(t7, t8)).pieceId = null;
        return B.AudioAssets_throwSound;
      }
    },
    revertIncapacition$1(shoveGame) {
      var t1, t2, t3;
      for (t1 = shoveGame.pieces, t1 = t1.get$values(t1), t2 = A._instanceType(t1), t3 = t2._eval$1("bool(Iterable.E)")._as(new A.ShoveGameMove_revertIncapacition_closure(shoveGame)), t1 = t1.get$iterator(t1), t2 = new A.WhereIterator(t1, t3, t2._eval$1("WhereIterator<Iterable.E>")); t2.moveNext$0();)
        t1.get$current(t1).isIncapacitated = false;
    },
    toString$0(_) {
      return "ShoveGameMove{oldSquare: " + this.oldSquare.toString$0(0) + ", newSquare: " + this.newSquare.toString$0(0) + ", shoveGameMoveType: " + this.shoveGameMoveType.toString$0(0) + "}";
    },
    $eq(_, other) {
      var t1, _this = this;
      if (other == null)
        return false;
      if (_this !== other)
        t1 = other instanceof A.ShoveGameMove && A.getRuntimeTypeOfDartObject(_this) === A.getRuntimeTypeOfDartObject(other) && _this.oldSquare.$eq(0, other.oldSquare) && _this.newSquare.$eq(0, other.newSquare) && _this.madeBy.playerName === other.madeBy.playerName && _this.shoveGameMoveType === other.shoveGameMoveType;
      else
        t1 = true;
      return t1;
    },
    get$hashCode(_) {
      var _this = this,
        t1 = _this.oldSquare,
        t2 = _this.newSquare;
      return (t1.get$hashCode(t1) ^ t2.get$hashCode(t2) ^ B.JSString_methods.get$hashCode(_this.madeBy.playerName) ^ A.Primitives_objectHashCode(_this.shoveGameMoveType)) >>> 0;
    },
    set$thrownPiece(thrownPiece) {
      this.thrownPiece = type$.nullable_ShovePiece._as(thrownPiece);
    }
  };
  A.ShoveGameMove_revertIncapacition_closure.prototype = {
    call$1(element) {
      type$.ShovePiece._as(element);
      return element.owner.$eq(0, this.shoveGame.currentPlayersTurn) && element.isIncapacitated;
    },
    $signature: 34
  };
  A.ShoveGameMoveType.prototype = {
    _enumToString$0() {
      return "ShoveGameMoveType." + this._name;
    }
  };
  A.ShovePiece.prototype = {
    $eq(_, other) {
      if (other == null)
        return false;
      if (this === other)
        return true;
      return other instanceof A.ShovePiece && other.pieceType === this.pieceType && other.owner.$eq(0, this.owner);
    },
    get$hashCode(_) {
      var t1 = this.owner;
      return (A.Primitives_objectHashCode(this.pieceType) ^ B.JSString_methods.get$hashCode(t1.playerName) ^ B.JSBool_methods.get$hashCode(t1.isWhite)) >>> 0;
    }
  };
  A.ShovePlayer.prototype = {};
  A.ShoveSquare.prototype = {
    toString$0(_) {
      return "ShoveSquare{x: " + this.x + ", y: " + this.y + ", piece: " + A.S(this.pieceId) + "}";
    },
    $eq(_, other) {
      var t1, _this = this;
      if (other == null)
        return false;
      if (_this !== other)
        t1 = other instanceof A.ShoveSquare && A.getRuntimeTypeOfDartObject(_this) === A.getRuntimeTypeOfDartObject(other) && _this.x === other.x && _this.y === other.y && _this.pieceId == other.pieceId;
      else
        t1 = true;
      return t1;
    },
    get$hashCode(_) {
      return B.JSInt_methods.get$hashCode(this.x) ^ B.JSInt_methods.get$hashCode(this.y) ^ J.get$hashCode$(this.pieceId);
    }
  };
  A.AudioAssets.prototype = {
    _enumToString$0() {
      return "AudioAssets." + this._name;
    }
  };
  ...
  A._BaseJsChannel.prototype = {
    _postResponse$1(res) {
      ...
      A.WorkerResponseExt_wrapResponse(res);
      try {
        B.MessagePort_methods.postMessage$1(this._sendPort, res);
      } catch (exception) {
        ex = A.unwrapException(exception);
        st = A.getTraceFromException(exception);
        A.Squadron_severe("failed to post response " + A.S(res) + ": error " + A.S(ex));
        t1 = A.SquadronException_from(ex, st);
        throw A.wrapException(t1);
      }
    },
    _inspectAndPostResponse$1(res) {
      var ex, st, t1, exception;
      A.WorkerResponseExt_wrapResponse(res);
      try {
  ...
  A._JsWorkerChannel.prototype = {
    reply$1(_, data) {
      return this._postResponse$1([null, data, null, null, null]);
    },
    inspectAndReply$1(data) {
      return this._inspectAndPostResponse$1([null, data, null, null, null]);
    },
    error$1(_, error) {
      var message;
      if (A.Squadron_debugMode()) {
        message = new A._JsWorkerChannel_error_closure(error).call$0();
        A.printString("[DEBUG] " + A.S(message));
      }
      this._postResponse$1([null, null, A.SquadronException_from(error, null), null, null]);
    },
    $isWorkerChannel: 1
  };
  ...
  A.WorkerMonitor.prototype = {
    _getTokenRef$1(token) {
      return token == null ? $.$get$CancellationTokenReference_noToken() : this._cancelTokens.putIfAbsent$2(0, token._cancellation_token$_id, new A.WorkerMonitor__getTokenRef_closure(token));
    },
    _uninstall$1(installer) {
    },
    _shutdown$0() {
      var uninstall = this._uninstall$1(this._installer),
        t1 = this._terminate;
      if (uninstall instanceof A._Future)
        uninstall.whenComplete$1(t1);
      else
        t1.call$0();
    },
  ...
  A.WorkerMonitor__getTokenRef_closure.prototype = {
    call$0() {
      var t1 = this.token._cancellation_token$_id,
        t2 = ++$.$get$TokenId__instance().__token_id$_id,
        t3 = $.Squadron__instance;
      t3 = t3 == null ? null : t3._id;
      t3 = new A.CancellationTokenReference(true, null, "" + t2 + "@" + A.S(t3));
      t3._cancellation_token$_id = t1;
      return t3;
    },
    $signature: 37
  };
  A.WorkerRunner.prototype = {
    ...
    connect$body$WorkerRunner(startRequest, channelInfo, initializer) {
      var $async$goto = 0,
        ...
        $async$handler = 1, $async$currentError, $async$self = this, client, service, $init, operations, install, ex, st, t2, t3, sq, value, exception, t1, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (!t1)
                A.WorkerRequestExt_unwrapRequest(startRequest);
              client = t1 ? null : type$.nullable_WorkerChannel._as(J.$index$ax(startRequest, 1));
              if (t1)
                throw A.wrapException(A.SquadronErrorExt_create("connection request expected", A.StackTrace_current()));
              else if (client == null)
                throw A.wrapException(A.SquadronErrorExt_create("missing client for connection request", A.StackTrace_current()));
              $async$handler = 3;
              t1 = J.getInterceptor$ax(startRequest);
              if (A._asInt(t1.$index(startRequest, 2)) !== -1) {
                t1 = A.SquadronErrorExt_create("connection request expected", A.StackTrace_current());
                throw A.wrapException(t1);
              } else {
                t2 = $async$self._operations;
                if (t2.__js_helper$_length !== 0) {
                  t1 = A.SquadronErrorExt_create("already connected", A.StackTrace_current());
                  throw A.wrapException(t1);
                }
              }
              t3 = A._asStringQ(t1.$index(startRequest, 6));
              t3.toString;
              sq = A.Squadron__getOrInitialize();
              if (sq._id == null) {
                value = B.JSString_methods.trim$0(t3);
                if (value.length !== 0)
                  sq._id = value;
              }
              t3 = A.Squadron__getOrInitialize();
              if (t3._parentChannel == null)
                t3._parentChannel = client;
              t3 = A._asIntQ(t1.$index(startRequest, 5));
              t3.toString;
              sq = A.Squadron__getOrInitialize();
              sq._logLevel = t3;
              t1 = A._asIntQ(t1.$index(startRequest, 0)) != null;
              $.Squadron___debugMode = t1;
              t3 = $.Squadron__instance;
              if (t3 != null)
                t3._debugMode = t1;
              service = null;
            ...
            case 6:
              // then
              t1 = $init;
              if (!type$.Future_WorkerService._is(t1)) {
                type$.WorkerService._as(t1);
                t3 = new A._Future($.Zone__current, type$._Future_WorkerService);
                t3._state = 8;
                t3._resultOrListeners = t1;
                t1 = t3;
              }
              $async$goto = 9;
              return A._asyncAwait(t1, $async$connect$3);
            case 9:
              // returning from await.
            ...
            case 7:
              // join
              operations = service.get$_shove_game_evaluator_service$_operations();
              t1 = J.get$keys$x(operations);
              t3 = A._instanceType(t1);
              t3 = new A.WhereIterable(t1, t3._eval$1("bool(Iterable.E)")._as(new A.WorkerRunner_connect_closure()), t3._eval$1("WhereIterable<Iterable.E>"));
              if (!t3.get$isEmpty(t3)) {
                t1 = A.SquadronErrorExt_create("invalid command identifier in service operations map; command ids must be > 0", A.StackTrace_current());
                throw A.wrapException(t1);
              }
              t2.addAll$1(0, operations);
            ...
            case 11:
              // join
              client._inspectAndPostResponse$1([null, channelInfo, null, null, null]);
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
              break;
    ...
    processMessage$body$WorkerRunner(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, client, tokenRef, op, result, reply, e, st, t1, t2, t3, t4, token, exception, $async$exception;
      var $async$processMessage$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A.WorkerRequestExt_unwrapRequest(request);
              ...
              if (A._asInt(t1.$index(request, 2)) === -4) {
                ...
                t1 = type$.nullable_CancellationToken._as(t1.$index(request, 4));
                t1.toString;
                t1 = $async$self._monitor._getTokenRef$1(t1);
                if (t1._hasRef)
                  t1.super$CancellationToken$cancel(0);
                $async$returnValue = null;
                // goto return
                $async$goto = 1;
                break;
              } else if (A._asInt(t1.$index(request, 2)) === -2) {
                t1 = A._asIntQ(t1.$index(request, 5));
                t1.toString;
                ...
                throw A.wrapException(A.SquadronErrorExt_create("missing client for request: " + A.S(request), A.StackTrace_current()));
              t3 = $async$self._monitor;
              ++t3._executing;
              t4 = type$.nullable_CancellationToken;
              token = t3._getTokenRef$1(t4._as(t1.$index(request, 4)));
              if (token._hasRef) {
                ++token._refCount;
                if (t4._as(t1.$index(request, 4)) == null || t4._as(t1.$index(request, 4))._cancellation_token$_id !== token._cancellation_token$_id)
                  A.throwExpression(A.SquadronErrorExt_create("cancellation token mismatch", A.StackTrace_current()));
                t1.$indexSet(request, 4, token);
              } else if (t4._as(t1.$index(request, 4)) != null)
                A.throwExpression(A.SquadronErrorExt_create("Token reference mismatch", A.StackTrace_current()));
              tokenRef = token;
              $async$handler = 4;
              if (A._asInt(t1.$index(request, 2)) === -1) {
                t1 = A.SquadronErrorExt_create("unexpected connection request: " + A.S(request), A.StackTrace_current());
                throw A.wrapException(t1);
              } else {
                t4 = $async$self._operations;
                if (t4.__js_helper$_length === 0) {
                  t1 = A.WorkerException$("worker service is not ready", null, null, null);
                  throw A.wrapException(t1);
                }
              }
              op = t4.$index(0, A._asInt(t1.$index(request, 2)));
              if (op == null) {
                t1 = A.WorkerException$("unknown command: " + A.WorkerRequestImpl_get_command(request), null, null, null);
                throw A.wrapException(t1);
              }
            ...
            case 8:
              // join
              if (A._asBool(t1.$index(request, 7))) {
              ...
              t1.toString;
              reply = t1;
              if (result instanceof A._EventStream) {
            ...
            case 10:
              // then
              $async$goto = 13;
              return A._asyncAwait(A.WorkerChannelExt_pipe(client, result, reply, t3, tokenRef), $async$processMessage$1);
            case 13:
              // returning from await.
              // goto join
              $async$goto = 11;
            ...
            case 5:
              // finally
              $async$handler = 2;
              t1 = type$.CancellationTokenReference._as(tokenRef);
              if (t1._hasRef)
                --t1._refCount;
              if (t1._refCount === 0 && t1._cancellation_token$_exception == null)
                t3._cancelTokens.remove$1(0, t1._cancellation_token$_id);
              t1 = --t3._executing;
              if (t3._terminationRequested && t1 === 0)
                t3._shutdown$0();
  ...
  A.SquadronError.prototype = {
    ...
    serialize$0() {
      ...
      return A.List_List$unmodifiable([-1, this.message, t1], type$.dynamic);
    },
    toString$0(_) {
  ...
  A.WorkerException.prototype = {
    ...
    serialize$0() {
      ...
      return A.List_List$unmodifiable([-2, _this.message, t1, _this._workerId, _this._command], type$.dynamic);
    }
  };
  A.CancelledException.prototype = {
    serialize$0() {
      var _this = this,
        t1 = _this._stackTrace;
      t1 = t1 == null ? null : t1.toString$0(0);
      return A.List_List$unmodifiable([-3, _this.message, t1, _this._workerId, _this._command], type$.dynamic);
    }
  };
  A.TaskTimeoutException.prototype = {
    serialize$0() {
      ...
      return A.List_List$unmodifiable([-4, _this.message, t1, t2, t3, t4], type$.dynamic);
    }
  };
  ...
  A.CancellationToken.prototype = {
    addListener$1(_, listener) {
      ...
      if (this._cancellation_token$_exception != null)
        A.safeInvoke(listener);
      else {
        t1 = this._listeners;
        if (t1 == null) {
          t1 = A._setArrayType([], type$.JSArray_of_void_Function);
          this.set$_listeners(t1);
        }
  ...
  A.WorkerChannelExt_pipe_onDone.prototype = {
    call$0() {
      this._this._postResponse$1([null, null, null, true, null]);
  ...
  A.WorkerChannelExt_pipe_closure.prototype = {
    call$0() {
      var t1 = this.monitor,
        t2 = this.tokenRef,
        t3 = this.streamId,
      ...
      if (canceller != null) {
        ...
        if (t2._hasRef)
          t2.super$CancellationToken$removeListener(0, canceller);
  ...
  A.WorkerChannelExt_get__err_closure.prototype = {
    call$2(ex, st) {
      return this._this.error$1(0, A.SquadronException_from(ex, st));
    },
    $signature: 39
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static_0(A, "_js_helper_Primitives_dateNow$closure", "Primitives_dateNow", 9);
    ...
    _static_1(A, "shove_game_evaluator_service__$ShoveGameEvaluatorServiceInitializer$closure", "$ShoveGameEvaluatorServiceInitializer", 41);
    var _;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.FixedLengthListMixin, A._Record, A.MapView, A.ConstantMap, A._KeysOrValuesOrElementsIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A._SyncStarIterator, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A._MapBaseValueIterator, A._UnmodifiableMapMixin, A.Codec, A.Converter, A._JsonStringifier, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.MapEntry, A.Null, A._StringStackTrace, A.Stopwatch, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A._EventStreamSubscription, A.ImmutableListMixin, A.FixedSizeListIterator, A._StructuredClone, A._AcceptStructuredClone, A.NullRejectionException, A.IPlayer, A.ShoveGameMoveDto, A.ShoveGameStateDto, A.ShovePieceDto, A.ShovePlayerDto, A.ShoveSquareDto, A.ShoveGameEvaluator, A.ShoveGameEvaluatorService, A.ShoveGame, A.ShoveGameMove, A.ShovePiece, A.ShoveSquare, A._BaseJsChannel, A.CancellationToken, A.TokenId, A.WorkerMonitor, A.WorkerRunner, A.SquadronError, A.SquadronException, A.Squadron]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.JsLinkedHashMap_values_closure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._HashMap_values_closure, A.MapBase_entries_closure, A._JsonMap_values_closure, A._EventStreamSubscription_closure, A.promiseToFuture_closure, A.promiseToFuture_closure0, A._$ShoveGameStateDtoFromJson_closure1, A._$ShoveGameStateDtoFromJson_closure2, A.ShoveGameEvaluator_evaluateGameState_closure, A.ShoveGameEvaluator_evaluateGameState_closure0, A.ShoveGameEvaluator_evaluateGameState_closure1, A._$ShoveGameEvaluatorServiceWorkerService__operations_closure, A._$ShoveGameEvaluatorServiceWorkerService__operations_closure0, A.ShoveGame_ShoveGame$fromDto_closure1, A.ShoveGame_validateThrow_closure, A.ShoveGame_checkIfGameIsOver_listEquals, A.ShoveGame_checkIfGameIsOver_checkIfPlayerHasRepeatedSameMoveThreeTimes, A.ShoveGame_checkIfGameIsOver_checkIfPlayerHasRepeatedSameMoveThreeTimes_closure, A.ShoveGame_checkIfGameIsOver_closure, A.ShoveGame_checkIfGameIsOver_closure0, A.ShoveGameMove_revertIncapacition_closure, A.bootstrap_closure0, A.JsWorkerRunnerExt_get_handle_closure, A.WorkerRunner_connect_closure]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A.Primitives_initTicker_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__chainCoreFutureAsync_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.bootstrap_closure, A._JsWorkerChannel_error_closure, A.WorkerMonitor__getTokenRef_closure, A.WorkerChannelExt_pipe_onDone, A.WorkerChannelExt_pipe_closure]);
    ...
    _inheritMany(A.IPlayer, [A.MinMaxAi, A.RandomAi, A.ShovePlayer]);
    _inherit(A._$ShoveGameEvaluatorServiceWorkerService, A.ShoveGameEvaluatorService);
    _inheritMany(A._Enum, [A.PieceType, A.ShoveDirection, A.ShoveGameMoveType, A.AudioAssets]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      HashMap_of_int_and_Record_2_double_and_nullable_ShoveGameMove: findType("HashMap<int,+(double,ShoveGameMove?)>"),
      IPlayer: findType("IPlayer"),
      ImageData: findType("ImageData"),
      Iterable_dynamic: findType("Iterable<@>"),
      JSArray_Map_dynamic_dynamic: findType("JSArray<Map<@,@>>"),
      JSArray_ShoveGameMove: findType("JSArray<ShoveGameMove>"),
      JSArray_ShoveSquare: findType("JSArray<ShoveSquare>"),
      ...
      MapEntry_String_ShovePiece: findType("MapEntry<String,ShovePiece>"),
      MapEntry_String_ShovePieceDto: findType("MapEntry<String,ShovePieceDto>"),
      MapEntry_String_ShoveSquareDto: findType("MapEntry<String,ShoveSquareDto>"),
      MapEntry_of_Record_2_int_and_int_and_ShoveSquare: findType("MapEntry<+(int,int),ShoveSquare>"),
      ...
      PieceType: findType("PieceType"),
      Plugin: findType("Plugin"),
      Record: findType("Record"),
      Record_0: findType("+()"),
      Record_2_double_and_nullable_ShoveGameMove: findType("+(double,ShoveGameMove?)"),
      Record_2_int_and_int: findType("+(int,int)"),
      Rectangle_num: findType("Rectangle<num>"),
      SharedArrayBuffer: findType("SharedArrayBuffer"),
      ShoveGameMove: findType("ShoveGameMove"),
      ShoveGameMoveDto: findType("ShoveGameMoveDto"),
      ShoveGameMoveType: findType("ShoveGameMoveType"),
      ShovePiece: findType("ShovePiece"),
      ShovePieceDto: findType("ShovePieceDto"),
      ShoveSquare: findType("ShoveSquare"),
      ShoveSquareDto: findType("ShoveSquareDto"),
      ...
      _Future_WorkerService: findType("_Future<WorkerService>"),
      ...
      nullable_CancellationToken: findType("CancellationToken?"),
      ...
      nullable_ShovePiece: findType("ShovePiece?"),
  ...
  (function constants() {
    ...
    B.AudioAssets_bonk = new A.AudioAssets("bonk");
    B.AudioAssets_move = new A.AudioAssets("move");
    B.AudioAssets_scream = new A.AudioAssets("scream");
    B.AudioAssets_throwSound = new A.AudioAssets("throwSound");
...
;
    ...
    B.C_ShoveGameEvaluator = new A.ShoveGameEvaluator();
    ...
    B.ShoveGameMoveType_0 = new A.ShoveGameMoveType("move");
    B.ShoveGameMoveType_1 = new A.ShoveGameMoveType("thrown");
    B.Map_oy1Wi = new A.GeneralConstantMap([B.ShoveGameMoveType_0, "move", B.ShoveGameMoveType_1, "thrown"], A.findType("GeneralConstantMap<ShoveGameMoveType,String>"));
    B.PieceType_2_shover = new A.PieceType(2, "shover");
    B.PieceType_5_thrower = new A.PieceType(5, "thrower");
    B.PieceType_1_blocker = new A.PieceType(1, "blocker");
    B.PieceType_3_leaper = new A.PieceType(3, "leaper");
    B.Map_xwIwp = new A.GeneralConstantMap([B.PieceType_2_shover, "shover", B.PieceType_5_thrower, "thrower", B.PieceType_1_blocker, "blocker", B.PieceType_3_leaper, "leaper"], A.findType("GeneralConstantMap<PieceType,String>"));
    B.ShoveDirection_0 = new A.ShoveDirection("xPositive");
    B.ShoveDirection_1 = new A.ShoveDirection("xNegative");
    B.ShoveDirection_2 = new A.ShoveDirection("yNegative");
    B.ShoveDirection_3 = new A.ShoveDirection("yPositive");
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "CancellationTokenReference_noToken", "$get$CancellationTokenReference_noToken", () => {
      var t1 = ++$.$get$TokenId__instance().__token_id$_id,
        t2 = $.Squadron__instance;
      t2 = t2 == null ? null : t2._id;
      t2 = new A.CancellationTokenReference(false, null, "" + t1 + "@" + A.S(t2));
      t2._refCount = 1;
      t2._cancellation_token$_id = "";
      return t2;
    });
