...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    assertUnreachable() {
      throw A.wrapException(new A._UnreachableError(null));
    },
    ...
    WorkerRequestExt_unwrapRequest(_this) {
      ...
      ts = t1.$index(_this, 0);
      if (ts != null)
        t1.$indexSet(_this, 0, A.Duration$(new A.DateTime(Date.now(), false).toUtc$0()._value - $.$get$_sqEpoch()._value)._duration - A._asInt(ts));
    },
    WorkerResponseExt_wrapResponse(_this) {
      ...
      if (A.Squadron_debugMode())
        B.JSArray_methods.$indexSet(_this, 0, A.Duration$(new A.DateTime(Date.now(), false).toUtc$0()._value - $.$get$_sqEpoch()._value)._duration);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.ShoveGameEvaluator.prototype = {
    ...
    minmax$body$ShoveGameEvaluator(game, maximizingPlayer, depth, alpha, beta, stateCalculationCache, stopwatch) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, t1, t2, bestMove, bestScore, move, score;
            ...
            case 0:
              ...
              if (depth !== 0)
                if (!game.get$isGameOver()) {
                  stopwatch.get$elapsed().get$inSeconds();
                  t1 = false;
                } else
                  t1 = true;
              else
              ...
              game.get$currentPlayersTurn();
              t1 = game.getAllLegalMoves$0(), t1 = t1.get$iterator(t1), t2 = depth - 1, bestMove = null, bestScore = 1 / 0;
            case 3:
              // for condition
              if (!t1.moveNext$0()) {
                // goto after for
              ...
              move = t1.get$current(t1);
              game.move$1(move);
              $async$goto = 5;
              return A._asyncAwait($async$self.minmax$7$alpha$beta$stateCalculationCache$stopwatch(game, maximizingPlayer, t2, alpha, beta, stateCalculationCache, stopwatch), $async$minmax$7$alpha$beta$stateCalculationCache$stopwatch);
            case 5:
    ...
    evaluateGameState$2(game, maximizingPlayer) {
      var score, t1, square, pieceDistancetoOpponentGoal, t2;
      if (game.get$isGameOver()) {
        game.get$gameOverState();
        A.assertUnreachable();
        game.get$gameOverState();
        A.assertUnreachable();
        score = -500;
        ...
        score = 0;
      for (t1 = game.get$board(), t1 = t1.get$values(t1), t1 = t1.get$iterator(t1); t1.moveNext$0();) {
        square = t1.get$current(t1);
        square.get$piece();
        square.get$piece().get$owner();
        square.get$piece().get$owner();
        square.get$piece();
        square.get$piece().get$pieceType();
        square.get$piece().get$pieceType();
        square.get$piece().get$pieceType();
        pieceDistancetoOpponentGoal = game.getSquaresDistanceToGoal$2(square.get$piece().get$owner(), square).$div(0, 10);
        t2 = pieceDistancetoOpponentGoal.$negate(0);
        score = B.JSNumber_methods.$sub(score, t2);
        t2 = square.get$piece();
        t2.get$pieceType().get$pieceValue();
        score -= 0;
        square.get$piece().get$isIncapacitated();
        square.get$piece().get$pieceType();
      }
      return score;
    }
  ...
  A.ShoveGameEvaluatorService.prototype = {
    evaluateGameState$1(shoveGame) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.double),
        $async$returnValue;
      var $async$evaluateGameState$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = B.C_ShoveGameEvaluator.evaluateGameState$2(shoveGame, shoveGame.get$currentPlayersTurn());
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$evaluateGameState$1, $async$completer);
    },
    findBestMove$3(shoveGame, stopwatch, player) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Record_2_double_and_nullable_ShoveGameMove),
        $async$returnValue;
      var $async$findBestMove$3 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = B.C_ShoveGameEvaluator.minmax$5$stateCalculationCache$stopwatch(shoveGame, player, 20, A.HashMap_HashMap(type$.int, type$.Record_2_double_and_nullable_ShoveGameMove), stopwatch);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$findBestMove$3, $async$completer);
    }
  };
  ...
  A._$ShoveGameEvaluatorServiceWorkerService__operations_closure.prototype = {
    call$1($$) {
      ...
      return this.$this.evaluateGameState$1(type$.ShoveGame._as(J.$index$ax(t1._as(J.$index$ax(t1._as($$), 3)), 0)));
    },
    $signature: 23
  };
  A._$ShoveGameEvaluatorServiceWorkerService__operations_closure0.prototype = {
    call$1($$) {
      ...
      return this.$this.findBestMove$3(type$.ShoveGame._as(J.$index$ax(t1._as(t2.$index($$, 3)), 0)), type$.Stopwatch._as(J.$index$ax(t1._as(t2.$index($$, 3)), 1)), type$.IPlayer._as(J.$index$ax(t1._as(t2.$index($$, 3)), 2)));
    },
    $signature: 24
  };
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "shove_game_evaluator_service__$ShoveGameEvaluatorServiceInitializer$closure", "$ShoveGameEvaluatorServiceInitializer", 29);
    var _;
    _instance_1_i(_ = A._JsWorkerChannel.prototype, "get$reply", "reply$1", 2);
    _instance_1_u(_, "get$inspectAndReply", "inspectAndReply$1", 2);
    _static_1(A, "_transferables_Transferables__isBaseType$closure", "Transferables__isBaseType", 5);
    _static_1(A, "_transferables_Transferables__isSafeForTransfer$closure", "Transferables__isSafeForTransfer", 5);
    _static_1(A, "_transferables_Transferables__isNotSafeForTransfer$closure", "Transferables__isNotSafeForTransfer", 5);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(String,@)", "~(@)", "Null()", "~(~())", "bool(@)", "@(@)", "Null(@)", "~(@,@)", "~(Object?,Object?)", "~(String,String)", "~(MessageEvent)", "Future<Null>()", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Event)", "Null(@,@)", "@(@,@)", "Future<double>(List<@>)", "Future<+(double,ShoveGameMove?)>(List<@>)", "String()", "CancellationTokenReference()", "bool(int)", "~(Object,StackTrace)", "WorkerService(List<@>)"],
...
//# sourceMappingURL=service_worker.dart.js.map
